...
export const metadata: Metadata = {
  ...
  description: `See how RestoreAssist moves a claim from field capture to IICRC-aligned reporting, GST invoicing, and client approval — ${trialDays}-day trial with ${trialReports} report credits. Basic reports work without pasting an API key; provider charges apply only if you add your own key. ${BRAND.tagline}`,
  keywords: [
