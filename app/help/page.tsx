        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mb-12">
            <motion.div
              ...
              className={`p-8 rounded-lg border backdrop-blur-sm transition-all text-left ${darkMode ? "bg-[#1C2E47]/50 border-[#5A6A7B]/30 hover:bg-[#1C2E47]/70" : "bg-[#F4F5F6]/50 border-[#5A6A7B]/20 hover:bg-[#F4F5F6]/70"}`}
            >
              <BookOpen size={28} className="mb-4 text-[#8A6B4E]" />
              <h3
                className={`text-xl font-bold mb-2 ${darkMode ? "text-[#F4F5F6]" : "text-[#1C2E47]"}`}
                style={{
                  fontFamily:
