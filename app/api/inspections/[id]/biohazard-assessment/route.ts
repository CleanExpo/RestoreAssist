...
export async function GET(
  ...
  try {
    ...
    return fromException(req, err, { stage: "biohazard-assessment:get" });
  }
}
...
export async function POST(
  ...
  try {
    ...
    return fromException(req, err, { stage: "biohazard-assessment:post" });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return fromException(req, err, { stage: "biohazard-assessment:delete" });
  }
}
