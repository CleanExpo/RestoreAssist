  ...
  try {
    ...
    const updated = await prisma.claimSketch.update({
      ...
      data: {
        ...
        sketchData: body.sketchData !== undefined ? body.sketchData : sketch.sketchData,
        backgroundImageUrl: body.backgroundImageUrl !== undefined ? body.backgroundImageUrl : sketch.backgroundImageUrl,
        moisturePoints: body.moisturePoints !== undefined ? body.moisturePoints : sketch.moisturePoints,
        equipmentPoints: body.equipmentPoints !== undefined ? body.equipmentPoints : sketch.equipmentPoints,
      },
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: "Failed to delete sketch" }, { status: 500 })
  }
}
