...
export async function GET(
  ...
  try {
    ...
    return fromException(req, err, { stage: "hvac-assessment:get" });
  }
}
...
export async function POST(
  ...
  try {
    ...
    return fromException(req, err, { stage: "hvac-assessment:post" });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return fromException(req, err, { stage: "hvac-assessment:delete" });
  }
}
