...
function parseReportFromText(text: string): ParsedReportData {
  ...
  data.propertyAddress =
    extractField("Property Address") || extractField("Address") || "";
  data.inspectionDate =
    extractField("Inspection Date") || extractField("Date") || "";
  data.waterCategory =
    extractField("Water Category") || extractField("Category") || "";
  data.waterClass = extractField("Water Class") || extractField("Class") || "";
  data.sourceOfWater =
    extractField("Source of Water") || extractField("Source") || "";
  ...
  data.hvacAffected =
    extractField("HVAC Affected")?.toLowerCase().includes("yes") || false;
  data.estimatedDryingTime =
    parseInt(extractField("Estimated Drying Time")) || null;
