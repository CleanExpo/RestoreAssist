  ...
  try {
    ...
    if (
      ...
      moistureReadings = [
        {
          room:
            scope.siteVariables.structure || "Residential - Single Family Home",
          rh: "",
          airTemp: "",
          wme: "100%",
          areaTested:
      ...
      const areas = [
        {
          ...
          flooringType:
            scope.siteVariables?.materials || report.structuralDamage || "N/A",
          subFloor:
          ...
          age:
            ...
            (report.completionDate
              ...
              : "N/A"),
          insulation:
            scope.siteVariables?.insulation || report.structuralDamage || "N/A",
