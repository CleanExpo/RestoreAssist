...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json(
      { error: "Failed to update scope template", details: process.env.NODE_ENV === "development" ? error?.message : undefined },
      { status: 500 }
    )
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { error: "Failed to delete scope template", details: process.env.NODE_ENV === "development" ? error?.message : undefined },
      { status: 500 }
    )
  }
}
