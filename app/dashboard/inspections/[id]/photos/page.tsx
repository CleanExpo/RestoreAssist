    ...
    <div className="min-h-screen bg-[#050505] text-white pb-24">
      ...
      <div className="sticky top-0 z-40 bg-[#050505]/95 backdrop-blur border-b border-white/10 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <Badge variant="outline" className="text-white/50 border-white/20 shrink-0">
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div className="rounded-2xl bg-white/5 border border-white/10 p-4 space-y-3">
          ...
          {effectiveLocation && (
            <div className="flex items-center gap-1.5 text-xs text-[#D4A574]">
              ...
              Will tag as: <span className="font-medium">{effectiveLocation}</span>
            </div>
          )}
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-white/30">
            ...
            <p className="text-xs mt-1">Tap &ldquo;Take Photo&rdquo; to document the damage</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 gap-3">
            {photos.map((photo) => (
          ...
          <div className="flex items-center justify-between px-4 py-3 shrink-0">
            <div>
              {selectedPhoto.location && (
                <p className="text-sm font-medium text-white">{selectedPhoto.location}</p>
              )}
