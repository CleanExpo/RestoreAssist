...
const EXPERIENCE_LEVELS = [
  {
    value: "novice",
    label: "Novice",
    description: "New to restoration work",
    icon: GraduationCap,
    color: "text-blue-500",
    bg: "bg-blue-50 dark:bg-blue-900/20",
    border: "border-blue-200 dark:border-blue-800",
  ...
  },
  {
    value: "expert",
    label: "Expert",
    description: "5+ years, IICRC certified",
    icon: Award,
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="space-y-2">
        <label className="text-sm font-semibold text-neutral-700 dark:text-slate-300 uppercase tracking-wider">
          ...
          <span className="text-neutral-400 font-normal normal-case">
            (optional — for building code detection)
          </span>
        </label>
          ...
          {EXPERIENCE_LEVELS.map((level) => {
            ...
            return (
              <button
                ...
                onClick={() =>
                  setExperienceLevel(
                    level.value as "novice" | "experienced" | "expert",
                  )
                }
                className={cn(
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    {tpl.description && (
                      <div className="text-xs text-neutral-500 dark:text-slate-400 mt-0.5 line-clamp-1">
                        {tpl.description}
                      </div>
                    )}
                  </div>
      ...
      <div className="pt-4 border-t border-neutral-200 dark:border-slate-700">
        ...
        <p className="text-xs text-neutral-400 dark:text-slate-500 text-center mt-2">
          Est. {jobType === "WATER_DAMAGE" ? "10-15" : "8-12"} minutes • IICRC
          S500 compliant questions
        </p>
      </div>
    </div>
  );
