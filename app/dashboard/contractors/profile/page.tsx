...
export default function ContractorProfileDashboard() {
  ...
  const addCertification = async () => {
    if (
      ...
      setMessage({
        type: "error",
        text: "Please fill in all required certification fields",
      });
      return;
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="IICRC_WRT">
                    IICRC Water Damage Restoration
                  </option>
                  <option value="IICRC_AMRT">
                    IICRC Applied Microbial Remediation
                  </option>
                  <option value="IICRC_FSRT">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewArea({ ...newArea, postcode: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewArea({ ...newArea, suburb: e.target.value })
                  }
                  className="w-full px-4 py-2 bg-slate-700/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500"
                />
              </div>
