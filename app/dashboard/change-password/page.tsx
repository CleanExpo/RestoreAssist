...
export default function ChangePasswordPage() {
  ...
  const passwordMeetsRequirements =
    newPassword.length > 0 && passwordValidationErrors.length === 0;
      ...
      >
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              <Lock className="w-8 h-8 text-warning dark:text-warning" />
            </div>
            <h1
              className={cn(
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {errors.currentPassword && (
                <p className="mt-1 text-sm text-destructive dark:text-destructive flex items-center gap-1">
                  <AlertCircle size={14} />
                  {errors.currentPassword}
                </p>
              )}
              ...
              {newPassword.length > 0 && (
                <div className="mt-2 space-y-1">
                  {passwordValidationErrors.map((error, idx) => (
                    <p
                      key={idx}
                      className="text-xs text-destructive dark:text-destructive flex items-center gap-1"
                    >
                      <AlertCircle size={12} />
                      {error}
                    </p>
            ...
            <div>
              ...
              {passwordsMatch && (
                <p className="mt-1 text-sm text-success dark:text-success flex items-center gap-1">
                  <CheckCircle size={14} />
                  Passwords match
                </p>
              )}
