    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        {showFilters && (
          <div
            className={cn(
              "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-3 mt-3 border-t",
              "border-border",
            )}
          >
            <div>
      ...
      <CardContent>
        {loading ? (
          ...
          <div className="text-center py-12 space-y-3">
            <Activity
              className={cn("w-10 h-10 mx-auto", "text-muted-foreground/50")}
            />
            <div>
              ...
              <p className={cn("text-xs", "text-muted-foreground/70")}>
                Team activity will appear here as members create reports, start
                inspections, and join the team.
              </p>
            </div>
          </div>
        ) : (
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              {activities.map((activity, idx) => {
                ...
                const reportId = activity.metadata?.reportId as
                  | string
                  | undefined;
                const inspectionId = activity.metadata?.inspectionId as
                  | string
                  | undefined;
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 pt-0.5">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <Clock
                          className={cn("w-3 h-3", "text-muted-foreground/70")}
                        />
                        <span
