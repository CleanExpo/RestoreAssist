    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        <div>
          <h1
            className={cn(
              "text-2xl sm:text-3xl font-semibold mb-1 sm:mb-2",
              ...
              try {
                ...
                if (response.ok) {
                  ...
                  if (!data.canCreate) {
                    ...
                    toast.error(
                      "Please upgrade your package to create more reports",
                    );
                    router.push("/dashboard/pricing");
                    return;
                  }
      ...
      {filterOpen && (
        <div
          className={cn(
            "p-4 rounded-lg border space-y-4 animate-fade-in",
                  ...
                  {paginatedReports.map((report, i) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3 mb-2">
                        <div className="flex items-center gap-2 min-w-0">
                          <button
                            ...
                            className="flex-shrink-0 text-neutral-600 dark:text-white"
                            title={
                              selectedReports.includes(report.id)
                                ? "Deselect"
                                : "Select"
                          ...
                          <Link
                            ...
                            className="font-medium text-cyan-400 hover:text-cyan-300 hover:underline text-sm truncate"
                          >
                            {report.reportNumber ||
                              report.title ||
                              report.id.slice(0, 8) + "..."}
                        ...
                        <span
                          className={`flex-shrink-0 px-2 py-1 rounded-full text-xs font-medium ${statusColors[report.status as keyof typeof statusColors] || cn("bg-neutral-200 dark:bg-slate-500/20", "text-neutral-600 dark:text-slate-400")}`}
                        >
                          {report.status || "DRAFT"}
                        </span>
                      </div>
                      <div className="pl-6 space-y-1">
                        ...
                        >
                          {truncateText(getClientName(report), 40)}
                        </p>
                        <p
                          className={cn(
                            "text-xs",
                        ...
                        >
                          {truncateText(getPropertyAddress(report), 50)}
                        </p>
                        <div className="flex items-center gap-3 pt-1">
                          ...
                          {report.waterCategory && (
                            ...
                            >
                              {hazardIcons[
                                report.hazardType as keyof typeof hazardIcons
                              ] || "💧"}{" "}
                              {report.waterCategory}
                            </span>
                          )}
                      ...
                      <div className="flex items-center gap-2 mt-3 pl-6">
                        <Link
                          ...
                          className={cn(
                            ...
                            "text-neutral-600 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400",
                          )}
                          title="View Report"
                        >
                          <Eye size={16} />
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            "hover:bg-neutral-100 dark:hover:bg-slate-700",
                            "text-neutral-600 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400",
                          )}
              ...
              <table className="w-full text-sm">
                <thead>
                  ...
                  >
                    <th
                      className={cn(
                        "text-left py-3 px-3 sm:py-4 sm:px-6 font-medium",
                    ...
                    >
                      <button
                        ...
                        className={cn(
                          "flex items-center gap-1 sm:gap-2 transition-all duration-200 hover:scale-105 active:scale-95 group",
                    ...
                    <th
                      className={cn(
                        "text-left py-3 px-3 sm:py-4 sm:px-6 font-medium hidden md:table-cell",
                        "text-neutral-700 dark:text-slate-400",
                      )}
                    >
                      Property Address
                    ...
                    <th
                      className={cn(
                        "text-left py-3 px-3 sm:py-4 sm:px-6 font-medium hidden lg:table-cell",
                        "text-neutral-700 dark:text-slate-400",
                      )}
                    >
                      Postcode
                    ...
                    <th
                      className={cn(
                        "text-left py-3 px-3 sm:py-4 sm:px-6 font-medium hidden sm:table-cell",
                        "text-neutral-700 dark:text-slate-400",
                      )}
                    >
                      Updated
                      ...
                      >
                        <td className="py-3 px-3 sm:py-4 sm:px-6">
                          <button
                            onClick={() => toggleReportSelection(report.id)}
                            className={cn(
                              "flex items-center gap-2 transition-all duration-200 hover:scale-110 active:scale-95 group",
                              "text-neutral-700 dark:text-white",
                              "hover:text-neutral-900 dark:hover:text-white",
                            )}
                            title={
                        ...
                        <td className="py-3 px-3 sm:py-4 sm:px-6">
                          <Link
                            href={`/dashboard/reports/${report.id}`}
                            className="font-medium text-cyan-400 hover:text-cyan-300 hover:underline text-xs sm:text-sm"
                          >
                            {report.reportNumber ||
                              report.title ||
                              report.id.slice(0, 8) + "..."}
                        ...
                        <td className="py-3 px-3 sm:py-4 sm:px-6 hidden md:table-cell">
                          <span
                            ...
                            title={getPropertyAddress(report)}
                          >
                            ...
                            report.interviewSessionId ? (
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  router.push(
                                    `/dashboard/interviews/new?${params.toString()}`,
                                  );
                                }}
                                className={cn(
                                  "p-1.5 rounded transition-all duration-200 hover:scale-110 active:scale-95 hover:shadow-md group",
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        <p
          className={cn(
            "text-xs sm:text-sm order-2 sm:order-1",
            "text-neutral-500 dark:text-slate-400",
          )}
        >
