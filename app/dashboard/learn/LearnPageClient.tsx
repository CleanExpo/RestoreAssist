...
const LIBRARY: { slug: string; subtitle: string; category: string }[] = [
  ...
  { slug: "setup-wizard-integrations", subtitle: "Connect Xero or Ascora.", category: "integrations" },
  ...
  { slug: "remotion-tutorial-integrations", subtitle: "Connect Xero, Ascora and more.", category: "integrations" },
