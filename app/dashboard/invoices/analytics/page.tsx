...
export default function InvoiceAnalyticsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {/* Error state */}
      {error && (
        <div className="flex items-center gap-2 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-destructive dark:text-destructive text-sm">
                  ...
                  {topClients.map((client, idx) => (
                    ...
                    >
                      ...
                      {client.outstanding > 0 ? (
                        ...
                        <Badge
                          variant="secondary"
                          className="flex-shrink-0 text-xs text-success dark:text-success"
                        >
                          Paid up
                        </Badge>
                      )}
