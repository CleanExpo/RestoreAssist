...
function LinearIssueList({ output }: { output: unknown }) {
  ...
  if (
    ...
    return (
      <div className="rounded-md border border-rose-300 bg-rose-50 px-3 py-2 text-sm text-destructive">
...
function LinearWriteResult({
  ...
  if (parsed?.url) {
    return (
      <div className="rounded-md border border-emerald-300 bg-emerald-50 px-3 py-2 text-sm text-success">
        Done.{" "}
        {parsed.identifier ? (
