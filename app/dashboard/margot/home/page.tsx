...
function HeroTile() {
  ...
  return (
    <TileCard
      title="Margot Status"
      footer={<UpdatedAt ts={data?.fetchedAt} stale={data?.stale} />}
    >
      {loading ? (
        <LoadingRows />
      ) : (
        ...
        >
          {messages.map((m: TelegramMessage) => (
            ...
            >
              ...
              <span
                style={{
                  color: m.from === "user" ? "#141413" : "#4A6B8C",
                  overflow: "hidden",
      ...
      {loading ? (
        ...
        >
          {issues.map((issue: LinearIssue) => {
            const pri = PRIORITY_LABEL[issue.priority] ?? {
              label: "—",
              color: MUTED,
            };
            return (
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  style={{ color: "#4A6B8C", flexShrink: 0 }}
                >
        ...
        >
          {schedules.map((s: Schedule) => (
            ...
            >
              ...
              <span
                style={{ fontSize: 11, color: MUTED, fontFamily: "monospace" }}
              >
                {s.nextRunAt
    ...
    >
      ...
      >
        ...
        <a
          ...
          style={{ fontSize: 12, color: "#4A6B8C", textDecoration: "none" }}
        >
          Chat ↗
        </a>
      </header>
      ...
      >
        v1 · auto-refresh 60s ·{" "}
        <a href="/dashboard/margot" style={{ color: "#4A6B8C" }}>
          /dashboard/margot for chat
        </a>
      </footer>
    </div>
  );
