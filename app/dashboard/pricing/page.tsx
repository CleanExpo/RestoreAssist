        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              Select the perfect plan for your water damage restoration
              business. All plans include IICRC S500 compliance and professional
              reporting tools.
            </p>
          </div>
          ...
          <div className="mt-16 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-800/30 rounded-lg p-6">
                ...
                <p className="text-slate-400">
                  Absolutely. We use enterprise-grade security with encrypted
                  data storage and secure connections. Your client data is
