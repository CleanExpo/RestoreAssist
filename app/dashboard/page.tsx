...
export default function DashboardPage() {
    ...
    try {
      ...
      const reportsWithCost = reports.map((report: any) => {
        ...
        if (report.costEstimationData) {
          try {
            const costData =
              typeof report.costEstimationData === "string"
                ? JSON.parse(report.costEstimationData)
                : report.costEstimationData;
            if (costData?.totals?.totalIncGST)
              return costData.totals.totalIncGST;
          } catch (e) {
            // Ignore parse errors
          }
        }
      ...
      const totalRevenue = reportsWithCost.reduce(
  ...
  const fetchPendingInspections = async () => {
    try {
      ...
      const draftData = draftRes.ok
        ? await draftRes.json()
        : { inspections: [] };
      const submittedData = submittedRes.ok
        ? await submittedRes.json()
        : { inspections: [] };
      const combined = [
  ...
  const stats = [
    ...
    },
    {
      ...
      value: dashboardData.loading
        ? "..."
        : `$${Math.round(dashboardData.avgReportValue || 0).toLocaleString()}`,
      icon: DollarSign,
      color: "text-blue-400",
    },
    {
    ...
    >
      ...
      <div
        className={cn(
          ...
          "border-neutral-200 dark:border-slate-800/50",
      ...
      >
        <div className="px-4 sm:px-6 py-4 sm:py-6">
          ...
          >
            <h1
              className={cn(
                "text-2xl sm:text-3xl font-medium mb-1 sm:mb-2",
            ...
            <p
              className={cn(
                "text-sm sm:text-base text-neutral-600 dark:text-slate-400",
              )}
            >
      ...
      <main>
        <div className=" mx-auto space-y-8">
          ...
          {!hasActiveSubscription() && <UpgradeBanner variant="inline" />}
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className={cn(
                  "border rounded-xl p-4 sm:p-6 transition-all duration-300",
                  "bg-white/50 dark:bg-slate-800/50",
                  "border-neutral-200 dark:border-slate-700/50",
                  "hover:border-neutral-300 dark:hover:border-slate-600/50",
                )}
              >
                <div className="flex items-center justify-between mb-2 sm:mb-4">
                  <stat.icon
                    size={20}
                    className={`${stat.color} opacity-80 sm:w-6 sm:h-6`}
                  />
            ...
            {loadingPending ? (
                ...
                {[1, 2, 3].map((i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      "bg-neutral-100 dark:bg-slate-700/40",
                    )}
                  />
                ))}
              </div>
              ...
              <div className="text-center py-6">
                ...
                <a
                  href="/dashboard/inspections/new"
                  className={cn(
                    "inline-block mt-2 text-sm font-medium",
                    "text-cyan-600 dark:text-cyan-400",
                    "hover:text-cyan-700 dark:hover:text-cyan-300",
                  )}
                >
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          isDraft
                            ? "bg-neutral-400 dark:bg-slate-400"
                            : "bg-amber-400",
                        )}
                      />
          ...
          <div className="grid lg:grid-cols-3 gap-4 sm:gap-8">
            ...
            >
              ...
              >
                <h2
                  className={cn(
                    "text-lg sm:text-xl font-medium mb-4 sm:mb-6",
                    "text-neutral-900 dark:text-white",
                  )}
                  style={{ fontFamily: "Titillium Web, sans-serif" }}
                >
                  ...
                  {quickActions.map((action, index) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div
                          className={`w-10 h-10 rounded-lg bg-gradient-to-r ${action.color} flex items-center justify-center flex-shrink-0 transition-transform duration-200 group-hover:scale-110 group-hover:rotate-3`}
                        >
                          <action.icon
                            size={20}
                            className={cn(
                        ...
                        <ArrowRight
                          size={16}
                          className={cn(
                            "transition-all duration-200 flex-shrink-0 group-hover:translate-x-1 group-hover:scale-110",
                            "text-neutral-600 dark:text-slate-400",
                            "group-hover:text-cyan-600 dark:group-hover:text-cyan-400",
                          )}
                        />
        ...
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 max-w-md w-full shadow-2xl p-6">
            ...
            <p className="text-neutral-600 dark:text-slate-400 mb-6">
              Get the most out of Restore Assist by personalizing your
              experience: add your profile details, set up pricing, and connect
              your API in Integrations.
            </p>
            <div className="space-y-3">
              <button
                onClick={() => {
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-neutral-500 dark:text-slate-400">
                    Add your name, company & preferences
                  </p>
                </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-neutral-500 dark:text-slate-400">
                    Connect your AI API key to generate reports
                  </p>
                </div>
                <ArrowRight className="h-4 w-4 text-neutral-400" />
              </button>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 max-w-lg w-full shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => {
                    ...
                    toast.success(
                      "Setup skipped! You can complete it anytime from Settings.",
                      { duration: 3000 },
                    );
                  }}
            ...
            <div className="p-6 space-y-4">
              {guidedStep === "api" && (
                <>
                  ...
                  <p className="text-gray-700 dark:text-slate-300">
                    Add your Anthropic API key to enable AI-powered report
                    generation and unlock personalized features.
                  </p>
                  <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 rounded-lg p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-400">
                      ...
                      Personalizes report generation, enables advanced AI
                      features, and improves report quality significantly.
                    </p>
              ...
              {guidedStep === "pricing" && (
                <>
                  ...
                  <p className="text-gray-700 dark:text-slate-300">
                    Set up your business rates for labour, equipment, and
                    services to ensure accurate cost estimations.
                  </p>
                  <div className="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 rounded-lg p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-400">
                      ...
                      Ensures accurate cost estimations and professional quotes
                      for your clients.
                    </p>
                    <p className="text-xs text-gray-500 dark:text-slate-500 mt-1">
                      ⏱️ Est. 5 minutes
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      onClick={() => {
                        setShowGuidedModal(false);
                        router.push(
                          "/dashboard/pricing-config?onboarding=true",
                        );
                      }}
              ...
              {guidedStep === "report" && (
                <>
                  ...
                  <p className="text-gray-700 dark:text-slate-300">
                    Generate your first professional restoration report to test
                    the system and see how it works with your settings.
                  </p>
                  <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 rounded-lg p-3">
                    <p className="text-xs text-gray-600 dark:text-slate-400">
                      <strong className="text-gray-900 dark:text-white">
                      ...
                      Test the system and see how reports are generated with
            ...
            <div className="px-6 pb-6">
              <div className="flex items-center justify-center gap-2">
                <div
                  className={`w-2.5 h-2.5 rounded-full transition-all ${guidedStep === "api" ? "bg-cyan-500 w-8" : "bg-gray-300 dark:bg-slate-600"}`}
                ></div>
                <div
                  className={`w-2.5 h-2.5 rounded-full transition-all ${guidedStep === "pricing" ? "bg-emerald-500 w-8" : "bg-gray-300 dark:bg-slate-600"}`}
                ></div>
                <div
                  className={`w-2.5 h-2.5 rounded-full transition-all ${guidedStep === "report" ? "bg-blue-500 w-8" : "bg-gray-300 dark:bg-slate-600"}`}
                ></div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg border border-neutral-200 dark:border-slate-700 max-w-md w-full p-6 shadow-xl">
            ...
            <div className="space-y-4">
              <p className="text-neutral-700 dark:text-slate-300">
                To create reports and clients, you need an active subscription
                (Monthly or Yearly plan).
              </p>
              <p className="text-sm text-neutral-600 dark:text-slate-400">
                Upgrade now to unlock all features including unlimited reports,
                client management, API integrations, and priority support.
              </p>
