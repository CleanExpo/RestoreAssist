    ...
    <div className="min-h-screen bg-[#1C2E47]">
      ...
      <article className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-14 p-8 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-center shadow-xl">
          <h3 className="text-xl font-bold mb-2">Restore smarter with RestoreAssist</h3>
          <p className="mb-6 opacity-90 max-w-lg mx-auto">
            IICRC S500-compliant inspections, automated scope generation, and drying validation
            in one platform.
          </p>
          <Link
            href="/signup"
...
function parseTranscript(transcript: string): { heading?: string; body: string }[] {
