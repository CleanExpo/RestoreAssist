...
function LoginForm() {
  ...
  // The "Sign up for free" link below is hidden on the iOS Capacitor shell
  // because /signup redirects iOS users back to /login (existing behaviour
  // in app/signup/page.tsx) — showing the link would create a confusing
      ...
      >
        ...
        >
          ...
          {/* Sign in with Apple. Apple guideline 4.8 requires this option
              ...
              when the Apple provider is configured
