...
const capabilities = [
  {
    title: "NRPG-Compliant Line Items",
    description:
      "Every invoice line maps to NRPG rate categories so insurers can approve quotes faster with full cost transparency.",
  },
  {
    title: "Automatic Tax & GST",
    description:
      "GST is calculated automatically based on your ABN details and applied consistently across all invoices.",
  },
  {
    title: "One-Click PDF Export",
    description:
      "Export branded, print-ready invoices as PDF with a single click — ready to send to clients or attach to insurance claims.",
  },
]
    ...
    >
      ...
      <section className="pt-48 pb-20 px-6 relative z-10 min-h-[60vh] flex items-center bg-[#C4C8CA]/30 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          >
            Professional restoration invoices — compliant, accurate, and ready
            in seconds.
          </motion.p>
        </div>
      </section>
