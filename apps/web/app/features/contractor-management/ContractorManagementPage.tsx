...
const capabilities = [
  {
    ...
    description:
      "Browse and filter restoration contractors by location, certification, and rating. Every listing is verified against industry databases.",
  },
  {
    title: "Performance Tracking",
    description:
      "Monitor job completion rates, customer reviews, and response times to ensure you are working with the best contractors.",
  },
  {
    title: "Job Assignment & Scheduling",
    description:
      "Assign restoration jobs to contractors directly from your dashboard with built-in scheduling and notification workflows.",
  },
]
    ...
    >
      ...
      <section className="pt-48 pb-20 px-6 relative z-10 min-h-[60vh] flex items-center bg-[#C4C8CA]/30 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          >
            One platform to find, verify, and manage your restoration
            contractors.
          </motion.p>
        </div>
      </section>
