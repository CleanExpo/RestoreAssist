...
const highlights = [
  {
    name: "Hard Rate Boundaries",
    description: "Enforced pricing limits",
    details:
      "RestoreAssist applies NRPG rate boundaries so contractor quotes never exceed approved maximums for each trade category.",
  },
  {
    name: "Regional Rate Libraries",
    description: "Location-aware pricing",
    details:
      "Rates are sourced from NRPG-aligned regional cost libraries, ensuring quotes reflect local market conditions.",
  },
  {
    name: "Audit-Ready Reports",
    description: "Transparent cost breakdowns",
    details:
      "Every quote includes a line-by-line breakdown that maps directly to NRPG categories for easy insurer review.",
  },
]

export default function NRPGSubPage() {
    ...
    >
      ...
      <section className="pt-48 pb-20 px-6 relative z-10 min-h-[60vh] flex items-center bg-[#C4C8CA]/30 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          >
            NRPG-rated pricing enforced at every step of the quoting process.
          </motion.p>
        </div>
      </section>
