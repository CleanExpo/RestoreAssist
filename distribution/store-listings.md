# RestoreAssist — Store Listing Copy

## Google Play Store

### App Name

RestoreAssist — Water Damage Compliance
...
water damage,restoration,IICRC,moisture,mould,flood,insurance,scope,report,compliance,contractor
...
- Target age group: Everyone (business/professional app)
...
Both stores: Free (subscription required for full access)

---

## What's New (v1.0 — first release)

See `distribution/whatsnew/whatsnew-en-AU` for the Google Play release notes.
