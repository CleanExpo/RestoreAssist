...
test.describe('Billing API Authentication', () => {
  test('should require authentication for GET /api/check-active-subscription', async ({ request }) => {
  ...
  test('should require authentication for GET /api/credits', async ({ request }) => {
  ...
  test('should require authentication for GET /api/pricing-config', async ({ request }) => {
...
test.describe('Billing Public Pages', () => {
  test('should load the /pricing page with a visible H1 heading', async ({ page }) => {
...
test.describe('Billing Dashboard Navigation', () => {
  test('should redirect unauthenticated users from /dashboard/subscription to login', async ({ page }) => {
