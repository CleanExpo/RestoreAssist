...
test.describe('CRM API Authentication', () => {
  test('should require authentication for CRM endpoints', async ({ request }) => {
...
test.describe('CRM Dashboard Routes', () => {
  test('should redirect /dashboard/clients to login without auth', async ({ page }) => {
  ...
  test('should redirect /dashboard/analytics to login without auth', async ({ page }) => {
