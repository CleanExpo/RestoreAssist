...
test.describe('Workshop API Authentication', () => {
  test('should require authentication for GET /api/inspections', async ({ request }) => {
  ...
  test('should require authentication for GET /api/scopes', async ({ request }) => {
  ...
  test('should require authentication for GET /api/reports', async ({ request }) => {
  ...
  test('should require authentication for GET /api/restoration-documents', async ({ request }) => {
...
test.describe('Workshop Dashboard Navigation', () => {
  test('should redirect unauthenticated users from /dashboard/inspections to login', async ({ page }) => {
