...
export const IICRC_CHECKLISTS: ChecklistTemplate[] = [
  {
    ...
    category: 'water',
    damageClass: '1',
    description: 'Category 1 clean water loss with limited affected area. Minimal absorbent materials wet.',
    items: [
      {
  ...
  },
  {
    ...
    category: 'water',
    damageClass: '2',
    description: 'Category 2 grey water loss with significant structural wetting. Significant moisture absorbed into walls and floors.',
    items: [
      {
        itemType: 'extract_standing_water',
        description: 'Extract standing water with portable extractor',
      ...
      },
      {
        ...
        description: 'Apply EPA-registered antimicrobial agent to affected surfaces',
        quantity: 1,
        unit: 'job',
      ...
      },
      {
        ...
        description: 'Document technician PPE usage (gloves, N95, eye protection)',
        quantity: 1,
        unit: 'job',
  ...
  },
  {
    ...
    category: 'water',
    damageClass: '3',
    description: 'Category 3 grossly contaminated water. Requires containment and full remediation protocol.',
    items: [
      {
        itemType: 'extract_standing_water',
        description: 'Extract standing water with portable extractor',
      ...
      },
      {
        ...
        description: 'Establish containment barriers to prevent cross-contamination',
        quantity: 1,
        unit: 'job',
  ...
  },
  {
    ...
    name: 'Fire & Smoke',
    category: 'fire',
    description: 'Fire and smoke damage remediation per IICRC S700. Includes structural cleaning and odour control.',
    items: [
      {
      ...
      {
        itemType: 'soda_blast',
        description: 'Soda blast or chemical sponge wipe all smoke-affected surfaces',
        quantity: null,
        unit: 'sqm',
  ...
  },
  {
    ...
    category: 'mould',
    description: 'Mould remediation protocol per IICRC S520. Containment, cleaning, and post-remediation testing required.',
    items: [
      {
      ...
      },
      {
        ...
        description: 'Remove mould-impacted porous materials (drywall, insulation)',
        quantity: null,
        unit: 'sqm',
