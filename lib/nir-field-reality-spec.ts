...
export const OFFLINE_REQUIREMENTS = {
  ...
  fullOfflineCapability: {
    required: true,
    scope: 'All form fields, photo capture, and measurement recording must function without internet',
    syncBehaviour: 'Auto-sync on connectivity restore. No manual sync required from technician.',
    conflictResolution: 'Last-write-wins for non-conflicting fields. Manual merge prompt for conflicting fields on same claim.',
    localStorageTarget: '500 inspection records with full photo sets without performance degradation',
  },
  ...
  syncStatusIndicator: {
    ...
    rationale: 'Technicians must know which data is confirmed server-side before leaving a site.',
  },
} as const
...
export const BLUETOOTH_EQUIPMENT = {
  ...
  p1_required: [
    ...
    },
    {
      ...
      dataPoints: ['relative_humidity_percent', 'temperature_celsius', 'dew_point_celsius'],
      integrationMethod: 'Bluetooth LE pairing',
      phase: 'Phase 2 pilot',
    },
  ],
...
export const PHYSICAL_UX_REQUIREMENTS = {
  ...
  gloveCompatible: {
    ...
    prohibitedGestures: ['swipe-to-confirm', 'pinch-zoom for primary navigation'],
    rationale: 'Category 3 water damage and mould sites require PPE including gloves.',
  },
  ...
  sunlightReadable: {
    ...
    highContrastMode: 'Required — all primary UI elements must pass WCAG AA at 600 nits',
    rationale: 'Roof inspections, exterior moisture mapping, and outdoor photo documentation are common.',
  },
  ...
  oneHandedOperation: {
    ...
    thumb_reach_zone: 'All critical fields accessible in thumb reach zone on 6-inch screen',
    rationale: 'Crawl space and subfloor inspections require one hand for stability or torch.',
  },
  ...
  tieredCompletion: {
    ...
    tiers: {
      critical: {
        ...
        examples: ['property_address', 'water_category', 'affected_area_sqm', 'min_one_photo'],
        blockSubmission: true,
      },
      supplementary: {
        description: 'Fields that SHOULD be completed but do not block submission',
        examples: ['all_moisture_readings', 'equipment_serial_numbers', 'full_scope_items'],
        blockSubmission: false,
        flagInReport: true, // Report flags incomplete supplementary fields
      },
    },
    rationale: 'Emergency water damage requires immediate documentation before conditions change. A critical-fields-only record is valid and submittable.',
  },
