...
export const MOCK_JOBS: ExternalJobData[] = [
  {
    ...
    description:
      "Burst pipe under kitchen sink caused flooding. Water extraction and drying required.",
  },
  {
    ...
    description:
      "Electrical fire in server room. Smoke and soot damage to multiple floors.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Roof and window damage from recent storm. Assessment for insurance claim.",
  },
  {
    ...
    description:
      "Sewage backup in basement level. Biohazard cleanup and sanitization.",
  },
  {
    ...
    description:
      "Flash flooding affected ground floor. Carpet and furniture damage.",
  },
];
