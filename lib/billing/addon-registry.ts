...
> = {
  ...
  [CLIENT_COMMS_ADDON.sku]: {
    sku: CLIENT_COMMS_ADDON.sku,
    name: CLIENT_COMMS_ADDON.name,
    description: CLIENT_COMMS_ADDON.description,
    amount: CLIENT_COMMS_ADDON.amount,
