...
async function renderInvoicePage(
  ...
  page.drawText(data.invoice.invoiceNumber, {
    x:
      width -
      margin -
      helvetica.widthOfTextAtSize(data.invoice.invoiceNumber, 16),
    y: yPosition + 5,
    size: 16,
    font: helveticaBold,
...
async function renderHeader(
  ...
  if (businessInfo?.businessEmail) {
    const emailWidth = helvetica.widthOfTextAtSize(
  ...
  if (businessInfo?.businessPhone) {
    const phoneWidth = helvetica.widthOfTextAtSize(
...
function getStatusBadge(status: string): {
  ...
  const statusMap: Record<string, any> = {
    DRAFT: {
      text: "DRAFT",
      bgColor: rgb(0.83, 0.83, 0.86),
      textColor: rgb(0.4, 0.4, 0.46),
      width: 60,
    },
    SENT: {
      text: "SENT",
      bgColor: rgb(0.59, 0.77, 0.95),
      textColor: rgb(0.05, 0.32, 0.66),
      width: 50,
    },
    VIEWED: {
      text: "VIEWED",
      bgColor: rgb(0.75, 0.65, 0.96),
      textColor: rgb(0.42, 0.24, 0.7),
      width: 60,
    },
    PARTIALLY_PAID: {
      text: "PART PAID",
      bgColor: rgb(0.98, 0.73, 0.15),
      textColor: rgb(0.45, 0.26, 0.0),
      width: 80,
    },
    PAID: {
      text: "PAID",
      bgColor: rgb(0.13, 0.77, 0.47),
      textColor: rgb(1, 1, 1),
      width: 50,
    },
    OVERDUE: {
      text: "OVERDUE",
      bgColor: rgb(0.94, 0.27, 0.27),
      textColor: rgb(1, 1, 1),
      width: 70,
    },
    CANCELLED: {
