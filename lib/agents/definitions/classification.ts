...
export const classificationConfig: AgentConfig = {
  ...
  description:
    "Determines IICRC S500 water damage category (1-4) and class (1-4) based on water source, affected area, moisture readings, and environmental data.",
  version: "1.0.0",
  capabilities: [
    {
...
export const classificationHandler: AgentHandler = async (
  input: TaskInput,
): Promise<TaskOutput> => {
