...
export const reportAnalysisConfig: AgentConfig = {
  ...
  description:
    "Analyzes technician field reports to extract structured data about affected areas, water source, materials, equipment, and hazards.",
  version: "1.0.0",
  capabilities: [
    {
      name: "analyze_technician_report",
      description:
        "Extracts structured information from technician field reports",
...
export const reportAnalysisHandler: AgentHandler = async (
  input: TaskInput,
): Promise<TaskOutput> => {
      ...
      errors: [
        {
          ...
          message: "No technician notes provided",
          recoverable: false,
        },
      ],
    };
