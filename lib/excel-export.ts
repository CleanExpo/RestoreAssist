...
export async function generateSingleReportExcel(
  ...
  const summaryRows = [
    ...
    { field: "Report Version", value: report.reportVersion?.toString() || "1" },
    {
      ...
      value: report.completenessScore ? `${report.completenessScore}%` : "N/A",
    },
    ...
    {
      field: "Technician Attendance Date",
      value: formatDateOnly(report.technicianAttendanceDate),
    },
    ...
    {
      field: "Affected Area (sqm)",
      value: report.affectedArea?.toString() || "N/A",
    },
    {
      field: "Total Cost",
      value: report.totalCost
        ? `$${Number(report.totalCost).toFixed(2)}`
        : "N/A",
    },
    {
      field: "Equipment Cost Total",
      value: report.equipmentCostTotal
        ? `$${Number(report.equipmentCostTotal).toFixed(2)}`
        : "N/A",
    },
    {
      field: "Estimated Drying Duration (days)",
      value: report.estimatedDryingDuration?.toString() || "N/A",
    },
  ...
  const inspectorRows = [
    {
      ...
      value: report.technicianName || report.user?.name || "N/A",
    },
  ...
  if (report.user) {
    inspectorRows.push(
      { field: "Business Name", value: report.user.businessName || "N/A" },
      {
        ...
        value: report.user.businessAddress || "N/A",
      },
  ...
  if (structuredData && structuredData.header) {
    if (!report.user?.businessName && structuredData.header.businessName) {
      inspectorRows.push(
        ...
        {
          field: "Business Name",
          value: structuredData.header.businessName || "N/A",
        },
        {
          field: "Business Address",
          value: structuredData.header.businessAddress || "N/A",
        },
        {
          field: "Business ABN",
          value: structuredData.header.businessABN || "N/A",
        },
        {
          field: "Business Phone",
          value: structuredData.header.businessPhone || "N/A",
        },
        {
          field: "Business Email",
          value: structuredData.header.businessEmail || "N/A",
        },
      );
    }
  }
  ...
  const structureRows = [
    ...
    {
      field: "Builder/Dev Company Name",
      value: report.builderDeveloperCompanyName || "N/A",
    },
    {
      field: "Builder/Dev Contact",
      value: report.builderDeveloperContact || "N/A",
    },
    {
      field: "Builder/Dev Address",
      value: report.builderDeveloperAddress || "N/A",
    },
    {
      field: "Builder/Dev Phone",
      value: report.builderDeveloperPhone || "N/A",
    },
    { field: "", value: "" },
    { field: "OWNER/MANAGEMENT INFORMATION", value: "" },
    {
      field: "Owner/Mgmt Contact",
      value: report.ownerManagementContactName || "N/A",
    },
    ...
    {
      field: "Date of Last Inspection",
      value: formatDateOnly(report.lastInspectionDate),
    },
    {
      field: "Building Changed Since Last Inspection",
      value: report.buildingChangedSinceLastInspection || "N/A",
    },
    {
      field: "Structure Changes Since Last Inspection",
      value: report.structureChangesSinceLastInspection || "N/A",
    },
    { field: "Previous Leakage", value: report.previousLeakage || "N/A" },
    {
      field: "Emergency Repair Performed",
      value: report.emergencyRepairPerformed || "N/A",
    },
  ];
  ...
  const contactRows = [
    { field: "Client Name", value: report.clientName || "N/A" },
    {
      field: "Client Contact Details",
      value: report.clientContactDetails || "N/A",
    },
    { field: "Client ID", value: report.clientId || "N/A" },
    { field: "Insurer Name", value: report.insurerName || "N/A" },
    {
      field: "Claim Reference Number",
      value: report.claimReferenceNumber || "N/A",
    },
    { field: "", value: "" },
    { field: "BUILDER/DEVELOPER INFORMATION", value: "" },
    {
  ...
  const propertyRows = [
    ...
    { field: "Property ID", value: report.propertyId || "N/A" },
    {
      field: "Building Age (Year Built)",
      value: report.buildingAge?.toString() || "N/A",
    },
  ...
  const incidentRows = [
    ...
    {
      field: "Phase 2 Start Date (Remediation/Drying)",
      value: formatDateOnly(report.phase2StartDate),
    },
    {
      field: "Phase 2 End Date (Remediation/Drying)",
      value: formatDateOnly(report.phase2EndDate),
    },
    {
      field: "Phase 3 Start Date (Verification/Handover)",
      value: formatDateOnly(report.phase3StartDate),
    },
    {
      field: "Phase 3 End Date (Verification/Handover)",
      value: formatDateOnly(report.phase3EndDate),
    },
  ];
  ...
  const envRows = [
    { field: "ENVIRONMENTAL DATA", value: "" },
    {
      field: "Temperature (°C)",
      value:
        structuredData?.environmental?.ambientTemperature?.toString() ||
        psychrometricAssessment?.temperature?.toString() ||
        psychrometricReadings?.[0]?.temperature?.toString() ||
        "N/A",
    },
    {
      field: "Humidity (%)",
      value:
        structuredData?.environmental?.humidityLevel?.toString() ||
        psychrometricAssessment?.humidity?.toString() ||
        psychrometricReadings?.[0]?.humidity?.toString() ||
        "N/A",
    },
    {
      field: "Dew Point (°C)",
      value:
        structuredData?.environmental?.dewPoint?.toString() ||
        psychrometricReadings?.[0]?.dewPoint?.toString() ||
        "N/A",
    },
    { field: "", value: "" },
    { field: "PSYCHROMETRIC ASSESSMENT", value: "" },
    {
      field: "Drying Index",
      value:
        structuredData?.psychrometric?.dryingIndex?.toString() ||
        psychrometricAssessment?.dryingIndex?.toString() ||
        "N/A",
    },
    {
      field: "Drying Status",
      value:
        structuredData?.psychrometric?.dryingStatus ||
        psychrometricAssessment?.dryingStatus ||
        "N/A",
    },
    {
      field: "Recommendation",
      value:
        structuredData?.psychrometric?.recommendation ||
        psychrometricAssessment?.recommendation ||
        "N/A",
    },
    { field: "", value: "" },
    ...
    {
      field: "Methamphetamine Screen",
      value: report.methamphetamineScreen || "N/A",
    },
    {
      field: "Tests Performed",
      value: report.methamphetamineTestCount?.toString() || "N/A",
    },
    {
    ...
    },
    {
      ...
      value: report.biologicalMouldCategory || "N/A",
    },
  ...
  const dryingRows = [
    {
      field: "Target Humidity (%)",
      value: report.targetHumidity?.toString() || "N/A",
    },
    {
      field: "Target Temperature (°C)",
      value: report.targetTemperature?.toString() || "N/A",
    },
    {
      field: "Estimated Drying Time (hours)",
      value: report.estimatedDryingTime?.toString() || "N/A",
    },
    {
      field: "Estimated Drying Duration (days)",
      value: report.estimatedDryingDuration?.toString() || "N/A",
    ...
    {
      field: "Dehumidification Capacity",
      value: report.dehumidificationCapacity?.toString() || "N/A",
    },
    {
      field: "Airmovers Count",
      value: report.airmoversCount?.toString() || "N/A",
    },
  ...
  // ============================================
  if (
    structuredData?.affectedAreas &&
    Array.isArray(structuredData.affectedAreas) &&
    structuredData.affectedAreas.length > 0
  ) {
    ...
    structuredData.affectedAreas.forEach((area: any) => {
      ...
      affectedAreasSheet.addRow({
        ...
        wetPercentage:
          typeof wetPercent === "number" ? `${wetPercent}%` : wetPercent,
        description: area.description || "N/A",
        materials: Array.isArray(area.materials)
          ? area.materials.join(", ")
          : "N/A",
      });
      ...
      if (
        ...
        Array.isArray(area.moistureReadings) &&
    ...
    applyAlternatingRows(
      affectedAreasSheet,
      2,
      structuredData.affectedAreas.length + 10,
    );
  }
  ...
  if (moistureReadings || structuredData?.moistureReadings) {
    ...
    const readings = Array.isArray(moistureReadings)
      ? moistureReadings
      : Array.isArray(structuredData?.moistureReadings)
        ? structuredData.moistureReadings
        : [];
  ...
  if (
    ...
    equipmentSelection.forEach((item: any) => {
      const cost =
        item.totalCost ||
        (item.dailyRate && item.quantity && item.duration
          ? item.dailyRate * item.quantity * item.duration
          : 0);
    ...
    applyAlternatingRows(
      equipmentDeploySheet,
      2,
      equipmentSelection.length + 1,
    );
  }
  ...
  if (structuredData?.compliance || geographicIntelligence) {
    ...
    if (structuredData?.compliance) {
      if (
        structuredData.compliance.standards &&
        Array.isArray(structuredData.compliance.standards)
      ) {
      ...
      if (structuredData.compliance.state) {
        complianceRows.push({
          standard: "State",
          details: structuredData.compliance.state,
        });
      }
      if (structuredData.compliance.buildingAuthority) {
        complianceRows.push({
          standard: "Building Authority",
          details: structuredData.compliance.buildingAuthority,
        });
      }
      if (structuredData.compliance.workSafetyAuthority) {
        complianceRows.push({
          standard: "Work Safety Authority",
          details: structuredData.compliance.workSafetyAuthority,
        });
      }
      if (structuredData.compliance.epaAuthority) {
        complianceRows.push({
          standard: "EPA Authority",
          details: structuredData.compliance.epaAuthority,
        });
      }
    }
    ...
    if (geographicIntelligence) {
      if (geographicIntelligence.state) {
        complianceRows.push({
          standard: "State",
          details: geographicIntelligence.state,
        });
      }
      if (geographicIntelligence.buildingAuthority) {
        complianceRows.push({
          standard: "Building Authority",
          details: geographicIntelligence.buildingAuthority,
        });
      }
      if (geographicIntelligence.workSafetyAuthority) {
        complianceRows.push({
          standard: "Work Safety Authority",
          details: geographicIntelligence.workSafetyAuthority,
        });
      }
      if (geographicIntelligence.epaAuthority) {
        complianceRows.push({
          standard: "EPA Authority",
          details: geographicIntelligence.epaAuthority,
        });
      }
    }
  ...
  if (report.technicianFieldReport) {
    ...
    notesSheet.columns = [{ header: "Field Notes", key: "notes", width: 100 }];
  ...
  if (psychrometricReadings || moistureReadings) {
    ...
    if (psychrometricReadings) {
      ...
      monitoringSheet.mergeCells(
        `A${monitoringSheet.rowCount}:B${monitoringSheet.rowCount}`,
      );
    ...
    if (moistureReadings) {
      ...
      monitoringSheet.mergeCells(
        `A${monitoringSheet.rowCount}:E${monitoringSheet.rowCount}`,
      );
  ...
  if (
    structuredData &&
    structuredData.type === "restoration_inspection_report"
  ) {
    ...
    Object.entries(structuredData).forEach(([key, value]) => {
      if (key === "type" || key === "version" || key === "generatedAt") {
        ...
        reportRows.push({ section: "", details: "" });
        reportRows.push({
          section: formatKey(key).toUpperCase(),
        ...
        if (value.length > 10) {
          reportRows.push({
            section: "",
            details: `... and ${value.length - 10} more items`,
          });
        }
      }
    });
          ...
          tierRows.push({
            ...
            response:
              typeof item.response === "object"
                ...
                : String(item.response || item.value || "N/A"),
          });
        });
  ...
  if (technicianAnalysis || report.technicianFieldReport) {
    ...
    if (report.technicianFieldReport) {
      techRows.push({
        field: "Technician Field Report (Raw Text)",
        value: report.technicianFieldReport,
      });
    }
    ...
    if (technicianAnalysis) {
      if (typeof technicianAnalysis === "object") {
        ...
        techRows.push({
          field: "Analysis Data",
          value: String(technicianAnalysis),
        });
      }
    }
  ...
  if (scopeData || report.scopeOfWorksDocument) {
    ...
    if (report.scopeOfWorksDocument) {
      scopeRows.push({
        field: "Scope of Works Document",
        value: report.scopeOfWorksDocument.substring(0, 10000),
      }); // Limit length
    }
  ...
  if (costData || report.costEstimationDocument) {
    ...
    if (report.costEstimationDocument) {
      costRows.push({
        field: "Cost Estimation Document",
        value: report.costEstimationDocument.substring(0, 10000),
      }); // Limit length
    }
  ...
  const complianceRows = [
    ...
    { field: "Containment Setup", value: report.containmentSetup || "N/A" },
    {
      ...
      value: report.decontaminationProcedures || "N/A",
    },
    {
      field: "Post Remediation Verification",
      value: report.postRemediationVerification || "N/A",
    },
  ...
  if (propertyCover) {
    insuranceRows.push({
      type: "Property Cover",
      details:
        typeof propertyCover === "object"
          ? JSON.stringify(propertyCover, null, 2)
  ...
  if (contentsCover) {
    insuranceRows.push({
      type: "Contents Cover",
      details:
        typeof contentsCover === "object"
          ? JSON.stringify(contentsCover, null, 2)
          : String(contentsCover),
    });
  }
  ...
  if (liabilityCover) {
    insuranceRows.push({
      ...
      details:
        typeof liabilityCover === "object"
          ? JSON.stringify(liabilityCover, null, 2)
          : String(liabilityCover),
    });
  }
  ...
  if (businessInterruption) {
    insuranceRows.push({
      ...
      details:
        typeof businessInterruption === "object"
          ? JSON.stringify(businessInterruption, null, 2)
  ...
  if (additionalCover) {
    insuranceRows.push({
      ...
      details:
        typeof additionalCover === "object"
          ? JSON.stringify(additionalCover, null, 2)
  ...
  if (geographicIntelligence) {
    ...
    if (typeof geographicIntelligence === "object") {
      ...
      geoRows.push({
        field: "Geographic Data",
        value: String(geographicIntelligence),
      });
    }
  ...
  if (
    ...
    typeof report.detailedReport === "string" &&
    !structuredData
  ) {
    const detailedSheet = workbook.addWorksheet("Detailed Report Text");
    detailedSheet.columns = [{ header: "Content", key: "content", width: 100 }];
  ...
  reports.forEach((report) => {
    summarySheet.addRow({
      ...
      inspectionDate: report.inspectionDate
        ? format(new Date(report.inspectionDate), "dd/MM/yyyy")
        : "N/A",
 ...
 */
export async function saveWorkbookAsBuffer(
