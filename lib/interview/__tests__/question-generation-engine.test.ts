...
describe("QuestionGenerationEngine", () => {
  ...
  describe("generateQuestions", () => {
    ...
    it("should filter questions based on job type", () => {
      ...
      const moldResult =
        QuestionGenerationEngine.generateQuestions(moldContext);
      const waterResult =
        QuestionGenerationEngine.generateQuestions(mockContext);
  ...
  describe("evaluateSkipLogic", () => {
    ...
    it("should handle array value matching in skip logic", () => {
      ...
      const previousAnswers = new Map([["materials_q", ["drywall", "wood"]]]);
  ...
  describe("evaluateConditionalShow", () => {
    ...
    it("should evaluate equality condition (eq) correctly", () => {
      ...
      expect(
        QuestionGenerationEngine.evaluateConditionalShow(question, answersTrue),
      ).toBe(true);
      expect(
    ...
    it("should evaluate includes condition correctly", () => {
      ...
      const answersFalse = new Map([
        ["materials_affected", ["carpet", "wood"]],
      ]);
    ...
    it("should enforce AND logic for multiple conditions", () => {
      ...
      expect(
        QuestionGenerationEngine.evaluateConditionalShow(question, answersBoth),
      ).toBe(true);
      expect(
        QuestionGenerationEngine.evaluateConditionalShow(
          question,
  ...
  describe("validateQuestion", () => {
    ...
    it("should fail validation for missing standards reference", () => {
      ...
      expect(result.valid).toBe(false);
      expect(result.errors.some((e) => e.includes("standards reference"))).toBe(
        true,
      );
    });
