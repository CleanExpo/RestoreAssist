...
const TIER1_QUESTIONS: Question[] = [
  {
    ...
    standardsJustification:
      "Water source determines Category 1/2/3 classification",
...

  {
    ...
    standardsJustification:
      "Time since loss affects contamination level and drying urgency",

    options: [
      {
        label: "Less than 12 hours ago",
        value: "lt_12h",
        helperText: "Fresh loss, minimal degradation",
      },
      {
        label: "12-48 hours ago",
        value: "12_48h",
        helperText: "Moderate urgency",
      },
      {
        label: "48-72 hours ago",
        value: "48_72h",
        helperText: "Significant degradation risk",
      },
      {
        label: "More than 72 hours ago",
        value: "gt_72h",
        helperText: "Category may upgrade due to time",
      },
    ],
    ...
    fieldMappings: [
      ...
      },
      {
        ...
        transformer: (answer, context) => {
          ...
          if (answer === "gt_72h")
            return "Category 2 or 3 (upgraded due to time)";
...

  {
    ...
    standardsJustification:
      "Area percentage affects water class and drying approach",
...

  {
    ...
    standardsReference: ["IICRC S500 s4", "NCC 2025 Building Materials"],
    standardsJustification:
      "Material types determine drying method and duration",
      ...
      },
      {
        ...
        transformer: (answer) => {
          const hasPorous =
            ...
            (answer.includes("drywall") || answer.includes("carpet"));
          return hasPorous
            ? "LGR Dehumidification + Air movers"
...

  {
    ...
    standardsJustification:
      "Temperature affects evaporation rate and drying duration",
    ...
    fieldMappings: [
      ...
      },
      {
        ...
        transformer: (temp) => {
          if (temp < 15)
            return "Temperature too low for efficient drying (< 15°C)";
...
const TIER2_QUESTIONS: Question[] = [
  {
    ...
    standardsReference: ["IICRC S500 s6-7 Psychrometric Assessment"],
    standardsJustification:
      "Humidity delta determines dehumidifier capacity and drying duration",
...

  {
    ...
    standardsReference: [
      "IICRC S500 s8 Microbial Assessment",
      "WHS Act 2011 Health Hazards",
    ],
    standardsJustification:
      "Visible growth requires antimicrobial treatment and safety protocols",
    ...
    fieldMappings: [
      ...
      },
      {
        ...
        transformer: (answer) =>
          answer === "visible_mold" || answer === "unsure",
        confidence: 90,
      },
    ],
...
const TIER3_QUESTIONS: Question[] = [
  {
    ...
    standardsJustification:
      "Building age determines asbestos/lead hazard assessment requirements",
    ...
    fieldMappings: [
      ...
      },
      {
        ...
        transformer: (answer) =>
          answer === "pre_1980" || answer === "1980_2000",
...

  {
    ...
    standardsReference: [
      "AS/NZS 3000:2023 Electrical Wiring",
      "WHS Act 2011 Electrical Safety",
    ],
    standardsJustification:
      "Electrical hazards require immediate isolation and licensed electrician assessment",
...

  {
    ...
    standardsJustification:
      "Specific equipment types determine repair requirements",
    ...
    fieldMappings: [
      {
        ...
        transformer: (answer) =>
          answer
            ? "Safety hazards present - requires assessment"
...
const TIER4_QUESTIONS: Question[] = [
...

  {
    ...
    standardsJustification:
      "Contamination level determines PPE and treatment requirements",
 ...
 */
export const INTERVIEW_QUESTION_LIBRARY: Question[] = [
  ...TIER1_QUESTIONS,
  ...TIER2_QUESTIONS,
  ...TIER3_QUESTIONS,
  ...TIER4_QUESTIONS,
  ...
  return INTERVIEW_QUESTION_LIBRARY.filter((q) => {
    ...
    return (
      ...
      (tier === 1
        ? seq <= 5
        : seq <= maxSeq &&
          seq > tierLimits[(tier - 1) as keyof typeof tierLimits])
    );
  });
}
 ...
 */
export function getQuestionsForSubscriptionTier(
  subscriptionTier:
    | "standard"
    | "premium"
    | "enterprise"
  ...
  const normalizedTier = (subscriptionTier || "standard").toLowerCase() as
    | "standard"
    | "premium"
    | "enterprise";
