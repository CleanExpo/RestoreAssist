    ...
    videos: [
      {
        ...
        description: 'Record and track moisture readings across multiple drying days.',
        youtubeId: '',
      },
      {
        episode: 6,
        ...
        description: 'Use RestoreAssist on iOS and Android for on-site documentation.',
        youtubeId: '',
      },
      {
        episode: 7,
        slug: 'offline-mode',
        title: 'Offline Mode',
        description: 'Keep working in basements and remote locations with full offline support.',
        youtubeId: '',
      },
      {
        episode: 8,
        ...
        description: 'Track ambient temperature, humidity, and GPP readings per drying day.',
        youtubeId: '',
      },
      {
        episode: 9,
        ...
        description: 'Attach geotagged, timestamped photos to every inspection step.',
        youtubeId: '',
      },
      {
        episode: 10,
        ...
        description: 'Track equipment placement, serial numbers, and IICRC S500 ratios.',
        youtubeId: '',
      },
    ],
  },
    ...
    videos: [
      {
        ...
        description: 'Let RestoreAssist auto-classify damage category and class per IICRC S500.',
        youtubeId: '',
      },
      {
        episode: 12,
        ...
        description: 'Produce a full PDF report with IICRC S500 citations in seconds.',
        youtubeId: '',
      },
      {
        episode: 13,
        ...
        description: 'Monitor active jobs, revenue, and compliance rates from your dashboard.',
        youtubeId: '',
      },
      {
        episode: 14,
        ...
        description: 'Use powerful search and filters to find any job by date, status, or address.',
        youtubeId: '',
      },
      {
        episode: 15,
      ...
      },
      {
        ...
        description: 'Collect legally binding e-signatures from technicians and property owners.',
        youtubeId: '',
      },
    ],
  },
    ...
    videos: [
      {
        ...
        description: 'Understand how RestoreAssist syncs data across devices in real time.',
        youtubeId: '',
      },
      {
        episode: 18,
        ...
        description: 'Scan equipment barcodes to assign and track gear without manual entry.',
        youtubeId: '',
      },
      {
        episode: 19,
        ...
        description: 'Set calibration reminders and track compliance for all measuring equipment.',
        youtubeId: '',
      },
      {
        episode: 20,
        ...
        description: 'Map affected rooms, materials, and moisture readings room by room.',
        youtubeId: '',
      },
      {
        episode: 21,
        ...
        description: 'Visualise drying progress and prove drying goal achievement to insurers.',
        youtubeId: '',
      },
      {
        episode: 22,
        ...
        description: 'Add team members, assign roles, and control access per inspection.',
        youtubeId: '',
      },
    ],
  },
  {
    ...
    videos: [
      ...
      },
      {
        ...
        description: 'Connect your Ascora CRM to sync jobs and pricing data automatically.',
        youtubeId: '',
      },
      {
        episode: 25,
        ...
        description: 'See how the AI scope narrative generator produces IICRC-cited scope documents.',
        youtubeId: '',
      },
      {
        episode: 26,
        ...
        description: 'Use AI to instantly classify water damage from photos and readings.',
        youtubeId: '',
      },
      {
        episode: 27,
        ...
        description: 'Access IICRC standards, compliance guides, and training materials.',
        youtubeId: '',
      },
      {
        episode: 28,
        slug: 'getting-help',
        title: 'Getting Help',
        description: 'Find help via email, live chat, and the RestoreAssist documentation.',
        youtubeId: '',
      },
    ],
  },
...
export const totalVideos = VIDEO_SERIES.reduce((acc, s) => acc + s.videos.length, 0);
