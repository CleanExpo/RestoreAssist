...
**Branch:** `release/sandbox-to-main-2026-05-16-final` @ `d5c23f13`
...
- **Two callers still on deprecated shim:** `lib/setup/checks.ts:330` and `lib/integrations/xero.ts:231`. Sub-task of Runtime Reconciliation plan.
