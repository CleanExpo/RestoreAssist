...
export default function Tier1Questions({
  reportId,
  onComplete,
  onGenerateEnhanced,
  onContinueToTier2,
      ...
      if (response.ok) {
        ...
        const initialDataFields = {
          ...
          incidentDate: data.incidentDate
            ...
            : "",
          technicianAttendanceDate: data.technicianAttendanceDate
  ...
  const handleSave = async () => {
    ...
    if (responses.T1_Q7_hazards.length === 0) {
      toast.error(
        'Please select hazard assessment (select "None identified" if no hazards)',
      );
      return;
    }
    ...
    try {
      ...
      const updateResponse = await fetch(`/api/reports/${reportId}`, {
        ...
        body: JSON.stringify({
          ...
          incidentDate: responses.incidentDate
            ? new Date(responses.incidentDate).toISOString()
            : null,
          technicianAttendanceDate: responses.technicianAttendanceDate
            ? new Date(responses.technicianAttendanceDate).toISOString()
            : null,
  ...
  const handleQuickFill = () => {
    setResponses((prev) => ({
      ...
      T1_Q5_roomsAffected:
        "Master Bedroom: Floor and lower wall sections affected. Ensuite: Floor, vanity cabinet base, and lower wall sections. Hallway: Floor only, minimal wall contact.",
  ...
  return (
    <div className="space-y-6">
      <div className="p-4 rounded-lg border-2 border-red-500/50 bg-red-50 dark:bg-red-500/10">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-destructive dark:text-destructive">
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            onChange={(e) =>
              setResponses((prev) => ({
                ...prev,
                technicianFieldReport: e.target.value,
              }))
            }
            rows={4}
            className="w-full px-3 py-2 bg-white dark:bg-slate-700/50 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-white"
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            onChange={(e) =>
              setResponses((prev) => ({
                ...prev,
                reportInstructions: e.target.value,
              }))
            }
            rows={3}
      ...
      {/* Advanced Tier 1 Questions */}
      <div className="p-4 rounded-lg border-2 border-red-500/50 bg-red-50 dark:bg-red-500/10">
        <h3 className="text-lg font-semibold text-destructive dark:text-destructive mb-2">
          ...
          {responses.T1_Q1_propertyType === "Other" && (
            <input
              ...
              onChange={(e) =>
                setResponses((prev) => ({
                  ...prev,
                  T1_Q1_propertyTypeOther: e.target.value,
                }))
              }
          ...
          {responses.T1_Q3_waterSource === "Other" && (
            <input
              ...
              onChange={(e) =>
                setResponses((prev) => ({
                  ...prev,
                  T1_Q3_waterSourceOther: e.target.value,
                }))
              }
              placeholder="Please specify"
              className="w-full px-4 py-2 bg-white dark:bg-slate-700/50 border border-slate-300 dark:border-slate-600 rounded-lg mt-2 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-400"
              ...
              <div className="mt-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setResponses((prev) => ({
                      ...prev,
                      T1_Q4_petsPresent: e.target.value,
                    }))
                  }
      ...
      <div className="p-6 rounded-lg border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/30">
        ...
        <textarea
          ...
          onChange={(e) =>
            setResponses((prev) => ({
              ...prev,
              T1_Q5_roomsAffected: e.target.value,
            }))
          }
          rows={6}
          ...
          {responses.T1_Q6_materialsAffected.includes("Unknown/Other") && (
            <input
              ...
              onChange={(e) =>
                setResponses((prev) => ({
                  ...prev,
                  T1_Q6_materialsOther: e.target.value,
                }))
              }
              placeholder="Please specify"
              className="w-full px-4 py-2 bg-white dark:bg-slate-700/50 border border-slate-300 dark:border-slate-600 rounded-lg mt-2 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-400"
      ...
      <div className="p-6 rounded-lg border-2 border-red-500/50 bg-red-50 dark:bg-red-500/10">
        <h3 className="text-lg font-semibold mb-4 text-destructive dark:text-destructive">
        ...
        <div className="space-y-2">
          {[
            ...
            <label
              key={option}
              className="flex items-center gap-3 p-3 rounded-lg hover:bg-red-100 dark:hover:bg-slate-700/30 cursor-pointer border border-transparent hover:border-red-300 dark:hover:border-slate-600"
            >
              <input
                type="checkbox"
          ...
          {responses.T1_Q7_hazards.includes("Other") && (
            <input
              ...
              onChange={(e) =>
                setResponses((prev) => ({
                  ...prev,
                  T1_Q7_hazardsOther: e.target.value,
                }))
              }
              placeholder="Please specify"
              className="w-full px-4 py-2 bg-white dark:bg-slate-700/50 border border-slate-300 dark:border-slate-600 rounded-lg mt-2 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-400"
