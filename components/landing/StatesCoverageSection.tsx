...
const states = [
  ...
  { name: "VIC", fullName: "Victoria", color: "from-brand-bronze to-brand-bronze" },
  ...
  { name: "TAS", fullName: "Tasmania", color: "from-brand-bronze to-blue-500" },
  {
    name: "ACT",
    fullName: "Australian Capital Territory",
    color: "from-indigo-500 to-brand-bronze",
  },
  {
    name: "NT",
    ...
    <SectionWrapper id="states-coverage" background="gradient">
      ...
      >
        <div className="text-center p-6 bg-slate-800/30 border border-slate-700/50 rounded-xl">
          <div className="w-12 h-12 bg-gradient-to-r from-brand-bronze to-brand-bronze rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="text-center p-6 bg-slate-800/30 border border-slate-700/50 rounded-xl">
          <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-brand-bronze rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="text-center p-6 bg-slate-800/30 border border-slate-700/50 rounded-xl">
          <div className="w-12 h-12 bg-gradient-to-r from-brand-bronze to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
