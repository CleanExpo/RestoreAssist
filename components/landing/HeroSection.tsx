      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(59, 130, 246, 0.3) 0%, rgba(6, 182, 212, 0.1) 50%, transparent 100%)",
            }}
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.2, 0.4, 0.2],
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(139, 92, 246, 0.3) 0%, rgba(59, 130, 246, 0.1) 50%, transparent 100%)",
            }}
            animate={{
              x: [0, 60, 0],
              y: [0, -40, 0],
          ...
          <motion.div
            className="absolute bottom-32 left-32 w-12 h-12 bg-gradient-to-r from-blue-500 to-brand-bronze rotate-45 opacity-70 shadow-lg shadow-brand-bronze/30"
            animate={{
              y: [0, 20, 0],
              x: [0, -12, 0],
              rotate: [45, 225, 405],
          ...
          <motion.div
            className="absolute top-1/3 left-1/4 w-6 h-6 bg-gradient-to-r from-brand-navy to-brand-bronze rounded-full opacity-80 shadow-lg shadow-brand-navy/30"
            animate={{
              y: [0, -35, 0],
              x: [0, 20, 0],
              scale: [1, 1.5, 1],
          ...
          <motion.div
            className="absolute bottom-20 left-1/3 w-20 h-20 bg-gradient-to-r from-brand-bronze to-brand-bronze rounded-full opacity-50 shadow-lg shadow-brand-bronze/30"
            animate={{
              y: [0, 30, 0],
              x: [0, -25, 0],
              scale: [1, 1.4, 1],
        ...
        <div className="relative z-10 text-center">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                ...
                className="px-10 py-4 bg-gradient-to-r from-blue-500 to-brand-bronze rounded-full font-medium text-lg hover:shadow-2xl hover:shadow-blue-500/50 transition-all duration-300"
          ...
          >
            <div className="flex items-center gap-3">
              <Zap size={20} className="text-brand-navy" />
              <span className="font-medium">10-15s Generation</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle size={20} className="text-brand-navy" />
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-brand-navy font-bold text-xl">$8,750 AUD</p>
              </div>
            </div>
            <div className="mt-6 pt-6 border-t border-slate-700/50">
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                <span className="px-3 py-1 bg-brand-bronze/20 text-brand-navy rounded-full">
                  NCC 2022 Compliant
                </span>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-brand-bronze to-blue-500 rounded-lg flex items-center justify-center">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Experience the power of AI-driven damage assessment with your
                  complimentary trial reports
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-brand-bronze to-brand-bronze rounded-lg flex items-center justify-center">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Standardised, compliant reports across all Australian states
                  and damage types
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Slash report writing time from hours to seconds while
