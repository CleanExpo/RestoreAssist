...
export default function FAQItem({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="border border-slate-700/50 bg-gradient-to-br from-slate-800/30 to-slate-800/50 rounded-2xl overflow-hidden hover:border-brand-bronze/50 transition-all duration-300"
    >
      <button
      ...
      >
        ...
        >
          {isOpen ? (
            <Minus size={24} className="text-brand-navy" />
          ) : (
