      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link
              ...
              className="px-6 py-4 bg-gradient-to-r from-blue-500 via-brand-bronze to-blue-500 rounded-md font-medium text-xl hover:shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105"
        ...
        >
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-r from-brand-bronze to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
