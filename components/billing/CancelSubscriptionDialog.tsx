      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-5 py-2">
          ...
          {(reason === "missing_feature" || reason === "other") && (
            <div className="rounded-lg border border-amber-200 dark:border-amber-800/50 bg-amber-50/50 dark:bg-amber-900/10 p-3 text-xs text-warning dark:text-warning">
