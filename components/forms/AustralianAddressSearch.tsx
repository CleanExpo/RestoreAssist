...
function formatSuggestion(result: NominatimResult): string {
  ...
  if (parsed.streetNumber || parsed.streetName) {
    parts.push(
      [parsed.streetNumber, parsed.streetName].filter(Boolean).join(" "),
    );
  }
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            "focus:outline-none focus:border-brand-bronze focus:ring-1 focus:ring-brand-bronze/30",
          ...
          {suggestions.map((result, idx) => {
            ...
            return (
              ...
              >
                <MapPin
                  size={14}
                  className="flex-shrink-0 mt-0.5 text-brand-bronze"
                />
