...
const getClassInfo = (waterClass: number) => {
  ...
  > = {
    1: {
      ...
      affectedMaterials: [
        "Limited to single room or small area",
        "Minimal building materials wet",
      ],
    },
    2: {
      name: "Class 2: Large",
...
export function IICRCClassificationVisualizer({
  ...
  const riskLevel =
    category === 1 && waterClass <= 2
      ? "low"
      : category === 1 && waterClass >= 3
        ? "medium"
        : category === 2 && waterClass <= 2
          ? "medium"
          : "high";
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Water Damage Category & Class Assessment
        </CardDescription>
      </CardHeader>
              ...
              {affectedArea && (
                <div className="p-3 bg-purple-50 border border-purple-200 rounded">
                  ...
                  <p className="text-sm text-purple-700">
                    Approximately {affectedArea} sq ft affected
                  </p>
                </div>
              )}
            </TabsContent>
