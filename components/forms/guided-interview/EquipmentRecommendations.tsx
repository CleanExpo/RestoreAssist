...
const calculateEquipmentNeeds = (
  props: EquipmentRecommendationsProps,
  ...
  const dehumidifierCount = lgr
    ? Math.ceil(cubicFeet / 1250)
    : Math.ceil(cubicFeet / 600);
  ...
  recommendations.push({
    ...
    totalEstimatedCost:
      (lgr ? 75 : 50) *
      dehumidifierCount *
      (iicrcClass === 1 ? 3 : iicrcClass === 2 ? 4 : 7),
...
export function EquipmentRecommendations({
  ...
  const totalDays = Math.max(
    ...recommendations.map((r) => r.estimatedDaysNeeded),
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Based on IICRC S500 classification (Category {iicrcCategory}, Class{" "}
          {iicrcClass})
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
              ...
              <div key={type} className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {Math.max(...items.map((r) => r.estimatedDaysNeeded))}{" "}
                      days
                    </p>
                  </div>
                </div>
                    ...
                    {item.specification.capacity && (
                      <div>
                        ...
                        <p className="font-semibold">
                          {item.specification.capacity} pints/day
                        </p>
                      </div>
                    )}
          ...
          <TabsContent value="timeline" className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(item.estimatedDaysNeeded / totalDays) * 100}%`,
                        }}
                      />
                    </div>
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-xs text-blue-700 mt-1">
                Total estimated duration: {totalDays} days (
        ...
        <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
          ...
          <ul className="text-xs text-muted-foreground space-y-1">
            <li>
              • All recommendations per IICRC S500 Standard & Reference Guide
            </li>
