        ...
        <div className="flex gap-3">
          ...
          {isComplete && onComplete && (
            <Button
              onClick={onComplete}
              disabled={disabled}
              className="gap-2 h-11 px-6 text-base font-semibold bg-gradient-to-r from-brand-bronze to-brand-bronze hover:from-emerald-700 hover:to-green-700 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 active:scale-95"
            >
