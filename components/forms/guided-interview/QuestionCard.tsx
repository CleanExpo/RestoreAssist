      ...
      case "numeric":
        return (
          <Input
            ...
            value={answer || ""}
            onChange={(e) =>
              setAnswer(e.target.value ? Number(e.target.value) : "")
            }
          />
        );
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-950/30 dark:to-green-950/30 border-2 border-emerald-200/80 dark:border-emerald-800/60 rounded-xl p-4 shadow-sm">
            <div className="flex items-start gap-2 mb-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-emerald-700 dark:text-brand-navy/80">
              ...
              {question.fieldMappings.map((mapping, idx) => (
                ...
                >
                  ...
                  {mapping.confidence < 100 && (
                    <span className="text-[10px] text-brand-bronze dark:text-brand-navy">
                      {mapping.confidence}%
                    </span>
                  )}
                </div>
          ...
          <div className="pt-2 border-t border-border/50">
            <div className="flex items-center justify-between text-xs text-muted-foreground">
              ...
              <span className="font-medium">
                {Math.round(((answeredQuestions + 1) / totalQuestions) * 100)}%
                complete
              </span>
            </div>
