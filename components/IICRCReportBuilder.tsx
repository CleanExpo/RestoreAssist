...
export default function IICRCReportBuilder({
  onReportComplete,
  initialData,
  isEditMode = false,
  ...
  const autoFillScenarios = {
    basic: {
      category1: {
        title:
          "Category 1 Water Damage Assessment - Clean Water Restoration Co.",
        clientName: "Clean Water Restoration Co.",
        propertyAddress: "123 Residential Street, Sydney NSW 2000",
        safetyHazards:
          "Minimal safety hazards, standard precautions sufficient",
      ...
      category3: {
        ...
        safetyHazards:
          "Biohazard contamination, structural integrity compromised, electrical hazards present, requires full PPE",
    ...
    classification: {
      ...
      category3: {
        ...
        waterClass: "Class 3",
        sourceOfWater:
          "Sewage backup from main line, contains pathogenic agents",
        affectedArea: 320,
      },
    },
    damage: {
      category1: {
        ...
        contentsDamage:
          "Minimal contents damage, mostly protective measures needed",
        hvacAffected: false,
      ...
      category2: {
        structuralDamage:
          "Water damage to drywall up to 2 feet, carpet padding saturated, hardwood flooring showing cupping",
        contentsDamage:
          "Furniture legs showing water staining, electronics on floor affected, personal items in contact with water",
        hvacAffected: true,
        electricalHazards:
          "GFCI outlets tripped, electrical panel shows moisture indicators",
        microbialGrowth:
          "No visible mould growth detected, but conditions favourable for development within 24-48 hours",
      },
      category3: {
        structuralDamage:
          "Severe water damage to all structural materials, carpet and padding require removal",
        contentsDamage:
          "All contents in contact with sewage require disposal or professional cleaning",
        hvacAffected: true,
        electricalHazards:
          "Multiple electrical hazards, power must be disconnected",
        microbialGrowth:
          "Active microbial growth present, requires immediate remediation",
      },
    },
    remediation: {
      category2: {
        remediationData: {
          ...
          containmentBarriers:
            "6-mil polyethylene sheeting with negative pressure",
          ...
          safetyProtocols:
            "Standard Category 2 protocols - moderate contamination control",
      ...
      category3: {
        remediationData: {
          containmentRequired: true,
          ppeRequired:
            "Full body protection, P100 respirators, chemical-resistant gloves, protective suits",
          containmentBarriers:
            "Full containment with 6-mil polyethylene, sealed joints, negative pressure mandatory",
          airFiltration: "Multiple HEPA filtration units with pre-filters",
          decontaminationProcedures:
            "Aggressive antimicrobial treatment, specialized cleaning protocols",
          wasteDisposal:
            "Biohazard disposal protocols, triple-bagged contaminated materials",
          safetyProtocols:
            "Full Category 3 biohazard protocols - maximum contamination control",
          isolationRequired: true,
          negativePressure:
            "Mandatory negative pressure with continuous monitoring",
          monitoringFrequency:
            "Continuous monitoring with real-time air quality assessment",
        },
      },
    },
    drying: {
    ...
    equipment: {
      category1: {
        equipmentSizing: {
          ...
          airmoversCount: 4,
          equipmentPlacement:
            "Strategic placement for optimal airflow across all affected surfaces",
      ...
      category2: {
        equipmentSizing: {
          ...
          monitoringEquipment:
            "Psychrometric monitoring devices, moisture meters, air quality monitors",
        },
      },
      category3: {
        equipmentSizing: {
          ...
          airmoversCount: 12,
          equipmentPlacement:
            "Maximum airflow with containment barriers, negative pressure systems",
          powerRequirements: "Dedicated 30-amp circuits with backup power",
          monitoringEquipment:
            "Advanced psychrometric monitoring, real-time air quality assessment, HEPA filtration monitoring",
        },
      },
    },
    monitoring: {
  ...
  const handleAutoFill = (scenario: string) => {
    ...
    const scenarioData =
      autoFillScenarios[stepKey]?.[
        scenario as keyof (typeof autoFillScenarios)[typeof stepKey]
      ];
    if (scenarioData) {
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-brand-bronze/20 text-brand-navy border border-brand-bronze/30 rounded-lg hover:bg-brand-bronze/30 transition-colors text-sm"
                >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Title will be auto-generated as you fill in client and water
                  category
                </p>
              </div>
              <div>
                ...
                />
                <p className="text-xs text-slate-400 mt-1">
                  Automatically generated - no changes needed
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium mb-2">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Standalone Contents">
                    Standalone Contents
                  </option>
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">
                Select from existing clients or use auto-fill scenarios above
              </p>
            </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Grossly contaminated, pathogenic agents present",
                    },
                  ].map((category) => (
                    <label
                      key={category.value}
                      className="flex items-start gap-3 p-4 bg-slate-700/30 border border-slate-600 rounded-lg hover:bg-slate-700/50 cursor-pointer"
                    >
                      <input
                        type="radio"
                        name="waterCategory"
                        ...
                        onChange={(e) =>
                          handleInputChange("waterCategory", e.target.value)
                        }
                        className="mt-1"
                      />
                      <div>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Minimal water absorption, low evaporation load",
                    },
                    {
                      value: "Class 2",
                    ...
                    },
                    {
                      ...
                      description:
                        "Water absorption from overhead, high evaporation load",
                    },
                    {
                      value: "Class 4",
                      label: "Class 4 - Specialty Drying Situations",
                      description:
                        "Deep water absorption, specialty drying required",
                    },
                  ].map((waterClass) => (
                    <label
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("waterClass", e.target.value)
                        }
                        className="mt-1"
                      />
                      <div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                onChange={(e) =>
                  handleInputChange("hvacAffected", e.target.checked)
                }
                className="w-5 h-5"
              />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={() =>
                    setReportData((prev) => ({ ...prev, remediationData: {} }))
                  }
                  className="px-4 py-2 bg-slate-500/20 text-slate-400 border border-slate-500/30 rounded-lg hover:bg-slate-500/30 transition-colors text-sm"
                >
                  Clear All
              ...
              <p className="text-xs text-slate-400 mt-2">
                Note: Category 1 (Clean Water) does not require remediation
                procedures
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={() =>
                    setReportData((prev) => ({ ...prev, dryingPlan: {} }))
                  }
                  className="px-4 py-2 bg-slate-500/20 text-slate-400 border border-slate-500/30 rounded-lg hover:bg-slate-500/30 transition-colors text-sm"
                >
                  Clear All
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={() =>
                    setReportData((prev) => ({ ...prev, equipmentSizing: {} }))
                  }
                  className="px-4 py-2 bg-slate-500/20 text-slate-400 border border-slate-500/30 rounded-lg hover:bg-slate-500/30 transition-colors text-sm"
                >
                  Clear All
            ...
            <EquipmentSizingGuidelines
              ...
              affectedArea={reportData.affectedArea}
              waterCategory={reportData.waterCategory}
              onSizingUpdate={(sizing) =>
                handleStepData("equipmentSizing", sizing)
              }
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={() =>
                    setReportData((prev) => ({ ...prev, monitoringData: {} }))
                  }
                  className="px-4 py-2 bg-slate-500/20 text-slate-400 border border-slate-500/30 rounded-lg hover:bg-slate-500/30 transition-colors text-sm"
                >
                  Clear All
            ...
            <MonitoringVerificationProcedures
              ...
              onMonitoringUpdate={(monitoring) =>
                handleStepData("monitoringData", monitoring)
              }
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={() =>
                    setReportData((prev) => ({ ...prev, insuranceData: {} }))
                  }
                  className="px-4 py-2 bg-slate-500/20 text-slate-400 border border-slate-500/30 rounded-lg hover:bg-slate-500/30 transition-colors text-sm"
                >
                  Clear All
            ...
            <InsuranceInformation
              onInsuranceUpdate={(insurance) =>
                handleStepData("insuranceData", insurance)
              }
          ...
          <div className="space-y-6">
            <div className="bg-brand-bronze/20 border border-brand-bronze/30 rounded-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-medium text-brand-navy">
                ...
                <div className="space-y-2 text-sm text-slate-300">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {reportData.reportNumber || "Not set"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Water Category:</span>
                    <span className="font-medium">
                      {reportData.waterCategory || "Not set"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Water Class:</span>
                    <span className="font-medium">
                      {reportData.waterClass || "Not set"}
                    </span>
                  </div>
                  <div className="flex justify-between">
    ...
    <div className="max-w-9xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-400">
          Professional water damage restoration report following ANSI/IICRC
          S500: 2021 standards
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="mb-6">
          ...
          <div className="w-full bg-slate-700 rounded-full h-2">
            <motion.div
              className="bg-gradient-to-r from-brand-bronze to-blue-500 h-2 rounded-full"
              initial={{ width: 0 }}
              ...
              >
                <motion.div
                  className={`w-12 h-12 rounded-full flex items-center justify-center border-2 mb-2 transition-all flex-shrink-0 ${
                    currentStep >= step.id
                      ? "bg-brand-bronze border-brand-bronze text-white shadow-lg shadow-brand-bronze/25"
                ...
                {index < steps.length - 1 && (
                  <div
                    className={`flex-1 h-0.5 mx-4 ${
                      currentStep > step.id ? "bg-brand-bronze" : "bg-slate-600"
                    }`}
                  />
                )}
              </div>
        ...
        <div className="flex items-center gap-4">
          ...
          {currentStep === steps.length ? (
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-brand-bronze to-brand-bronze rounded-lg text-white font-medium hover:shadow-lg hover:shadow-brand-bronze/50 transition-all flex items-center gap-2"
            >
              <CheckCircle size={20} />
            ...
            <button
              onClick={handleNext}
              className="px-6 py-3 bg-gradient-to-r from-brand-bronze to-blue-500 rounded-lg text-white font-medium hover:shadow-lg hover:shadow-brand-bronze/50 transition-all flex items-center gap-2"
            >
              Next Step
              <ArrowRight size={20} />
            </button>
