...
export default function ReportWorkflow({
  ...
  const [currentStage, setCurrentStage] = useState<WorkflowStage>(
    initialReportId ? "report-generation" : "initial-entry",
  );
  ...
  const stages = [
    ...
    },
    {
      ...
      completed:
        reportType === "enhanced" &&
        (currentStage === "tier3" || currentStage === "report-generation"),
    },
    {
      id: "tier3",
      label: "Tier 3",
  ...
  const visibleStages =
    reportType === "basic"
      ? stages.filter(
          (s) => s.id === "initial-entry" || s.id === "report-generation",
        )
      : reportType === "enhanced"
  ...
  return (
    <div className="space-y-6">
      ...
      {currentStage === "tier3" && reportId && (
        <Tier3Questions reportId={reportId} onComplete={handleTier3Complete} />
      )}
              ...
              <div className="p-4 rounded-lg border border-green-500/50 bg-green-500/10">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    >
                      You can optionally complete Tier 3 questions to optimise
                ...
                <button
                  ...
                  className={cn(
                    ...
                    "text-neutral-600 dark:text-slate-400",
                    "hover:text-neutral-800 dark:hover:text-slate-300",
                  )}
                >
