    ...
    <div className="space-y-4">
      ...
      <Card className="border-white/10 bg-white/5">
        ...
        <CardContent className="space-y-3">
          ...
          {isApprentice ? (
            <>
              <div className="flex gap-2 rounded-md border border-brand-navy/20 bg-brand-navy/5 p-3">
                <Info className="mt-0.5 h-4 w-4 shrink-0 text-brand-tan" />
      ...
      <Button
        ...
        className="w-full bg-brand-navy text-white hover:bg-cyan-700"
      >
        {isUploading ? (
          <>
