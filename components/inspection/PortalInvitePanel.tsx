  ...
  return (
    <div className="p-4 rounded-xl border border-neutral-200 dark:border-slate-700/50 bg-white dark:bg-slate-900/50">
      <div className="flex items-center gap-2 mb-3">
        <Link2 size={16} className="text-brand-tan" />
      ...
      {inviteStatus === "sent" && (
        <div className="flex items-center gap-2 text-sm text-brand-bronze dark:text-brand-bronze">
        ...
        <div className="space-y-3">
          <div>
            ...
            <select
              ...
              disabled={loading}
              className="w-full rounded-lg border border-neutral-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-navy"
            >
          ...
          <button
            ...
            className={cn(
              ...
              "bg-brand-navy hover:bg-brand-navy text-white disabled:opacity-50 disabled:cursor-not-allowed",
            )}
          >
            {sending ? (
