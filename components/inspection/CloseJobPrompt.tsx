    ...
    return (
      ...
      >
        <div className="flex items-start gap-3">
          <Lock
            className="h-5 w-5 text-brand-tan mt-0.5 shrink-0"
            aria-hidden="true"
          />
          <div className="min-w-0">
            <p className="font-semibold text-cyan-700 dark:text-brand-tan">
              Job Closed
            </p>
            <p className="text-sm text-cyan-700/80 dark:text-brand-tan/80 mt-0.5">
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-cyan-700/80 dark:text-brand-tan/80 mt-1">
