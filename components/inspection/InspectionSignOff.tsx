    ...
    <>
      <div className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 space-y-4">
        <div className="flex items-center gap-2">
          <PenLine className="h-5 w-5 text-brand-tan" />
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-navy"
              />
            </div>
            ...
            <label className="flex items-start gap-2.5 cursor-pointer">
              <input
                ...
                className="mt-0.5 h-4 w-4 rounded border-neutral-300 text-brand-tan focus:ring-brand-navy"
              />
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          {isFormUnlocked ? (
            <Button
              ...
              className="gap-2 bg-brand-navy hover:bg-cyan-700 text-white"
            >
              {submitting ? (
