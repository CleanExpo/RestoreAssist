  ...
  return (
    <div className="space-y-1">
      ...
      <div className="w-full bg-slate-700/50 rounded-full h-1.5 overflow-hidden">
        <div
          className="h-full rounded-full bg-gradient-to-r from-brand-bronze to-blue-500 transition-all duration-500"
          style={{ width: `${pct}%` }}
        />
      </div>
...
> = {
  ...
  completed: { label: "Done", colour: "text-brand-navy", icon: CheckCircle },
