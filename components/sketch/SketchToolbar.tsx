    ...
    >
      ...
      {!readonly && (
        <button
          ...
          onClick={onClear}
          className="w-11 h-11 flex items-center justify-center rounded-lg text-destructive hover:bg-rose-50 dark:hover:bg-rose-900/20 hover:text-destructive transition-all"
        >
          <Trash2 size={15} />
        </button>
      )}
