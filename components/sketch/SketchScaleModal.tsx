      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Ruler size={16} className="text-brand-navy" />
        ...
        {/* Current scale */}
        {currentScale && (
          <div className="flex items-start gap-2 p-2.5 rounded-lg bg-brand-bronze/10 border border-brand-bronze/20 text-xs text-brand-navy">
        ...
        <div className="flex gap-2">
          {step === "idle" && (
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-brand-bronze text-white text-sm font-medium hover:bg-brand-bronze transition-colors"
            >
              <Ruler size={14} />
              Start calibration
            </button>
      ...
      <span
        className={cn(
          "flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold border",
            ...
            ? "bg-brand-bronze border-brand-navy text-white"
            : active
