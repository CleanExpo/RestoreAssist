    ...
    >
      ...
      {!readonly && (
        <button
          ...
          className="flex items-center gap-1 ml-1 px-2 py-1.5 text-xs text-white/40 hover:text-brand-tan hover:bg-white/5 rounded-lg transition-colors flex-shrink-0"
        >
          <Plus size={12} />
          Add floor
        </button>
