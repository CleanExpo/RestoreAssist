    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          {PHOTO_CATEGORIES.map((category) => {
            ...
            return (
              <div
                key={category.id}
                className="p-4 rounded-lg border border-gray-200 dark:border-slate-600/50 bg-white dark:bg-slate-900/30"
              >
                <div className="flex items-center justify-between mb-2">
                  <div>
      ...
      <div className="sticky bottom-0 z-10 flex justify-end py-4 bg-white dark:bg-slate-950 border-t border-neutral-200 dark:border-slate-800">
        <button
          onClick={handleSave}
          disabled={loading}
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-brand-bronze rounded-lg font-medium hover:shadow-lg hover:shadow-green-500/50 transition-all disabled:opacity-50"
        >
