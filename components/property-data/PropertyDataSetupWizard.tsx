    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 max-w-lg w-full shadow-2xl">
        ...
        <div className="h-1 bg-gray-100 dark:bg-slate-700">
          <div
            className="h-full bg-gradient-to-r from-blue-500 to-brand-bronze transition-all duration-500"
        ...
        <div className="p-6 min-h-[280px] flex flex-col justify-between">
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-gradient-to-r from-blue-500 to-brand-bronze rounded-lg text-white text-sm font-medium hover:shadow-lg hover:shadow-blue-500/30 transition-all mt-2"
              >
            ...
            <div className="space-y-4">
              ...
              <div
                className={`rounded-xl border-2 p-6 flex flex-col items-center gap-3 transition-all ${
                  testResult === "success"
                    ? "border-brand-navy dark:border-brand-bronze bg-emerald-50 dark:bg-brand-bronze/10"
                    : testResult === "fail"
              ...
              >
                ...
                <p
                  className={`text-sm font-medium ${
                    testResult === "success"
                      ? "text-emerald-700 dark:text-brand-navy"
                      : testResult === "fail"
          ...
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-100 dark:border-slate-700">
            ...
            {step < 4 ? (
              <button
                onClick={handleNext}
                className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-blue-500 to-brand-bronze text-white rounded-lg text-sm font-medium hover:shadow-lg hover:shadow-blue-500/30 transition-all"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-brand-bronze to-brand-bronze text-white rounded-lg text-sm font-medium hover:shadow-lg hover:shadow-brand-bronze/30 transition-all"
              >
                Finish Setup
