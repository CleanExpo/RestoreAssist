        ...
        <div className="p-6 min-h-[280px] flex flex-col justify-between">
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-500/10 rounded-lg text-xs text-warning dark:text-warning">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                {testResult === "fail" && testError && (
                  <p
                    role="alert"
                    className="text-xs text-destructive dark:text-destructive text-center px-2"
                  >
                    {testError}
                  </p>
                )}
