  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-r from-blue-500 to-brand-tan rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center z-[100] group"
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50 rounded-t-lg">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-brand-tan rounded-full flex items-center justify-center">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors ${
                          selectedLanguage.code === lang.code
                            ? "bg-cyan-50 dark:bg-cyan-900/20 text-brand-tan dark:text-brand-tan font-medium"
              ...
              >
                {voiceEnabled ? (
                  isSpeaking ? (
                    <Volume2
                      size={16}
                      className="text-brand-tan animate-pulse"
                    />
                  ) : (
                    <Volume2 size={16} className="text-brand-tan" />
                  )
                ) : (
                  <VolumeX
                    size={16}
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-gray-100 dark:bg-slate-700 rounded-lg px-4 py-2">
                  <Loader2
                    className="animate-spin text-brand-tan dark:text-brand-tan"
                    size={16}
                  />
                </div>
              </div>
          ...
          <div className="p-4 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50 rounded-b-lg">
              ...
              <div className="flex items-center gap-2 mb-2 px-1">
                <div className="flex gap-0.5">
                  {[0, 1, 2].map((i) => (
                    <div
                      key={i}
                      className="w-1 bg-brand-navy rounded-full animate-pulse"
                      style={{
                        height: "12px",
                ...
                <span className="text-xs text-brand-tan font-medium">
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-lg focus:outline-none focus:border-brand-navy focus:ring-1 focus:ring-brand-navy/50 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-400 disabled:opacity-50"
              />

              <button
                onClick={handleSend}
                disabled={!input.trim() || isLoading}
                className="px-4 py-2 bg-gradient-to-r from-blue-500 to-brand-tan rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
