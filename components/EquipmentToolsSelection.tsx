          ...
          if (config && equipmentSelections.length > 0) {
            setEquipmentSelections((prev) =>
              prev.map((sel) => ({
                ...
                dailyRate:
                  sel.dailyRate || getEquipmentDailyRate(sel.groupId, config),
              })),
            );
          }
        }
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-blue-400 mb-1">
                  Why do we check this first?
                </h3>
                <p className="text-sm text-slate-300">
                  Before setting up equipment, we must understand the 'Energy'
                  in the air. The combination of Temperature and Humidity
                  determines if the air acts like a 'Thirsty Sponge' (Good) or a
                  'Saturated Sponge' (Bad). This sets the strategy for the whole
                  job.
                </p>
              </div>
            </div>
                ...
                {[1, 2, 3, 4].map((cls) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg border transition-colors ${
                      waterClass === cls
                        ? "border-brand-navy bg-brand-navy/20 text-brand-tan"
          ...
          <div className="flex justify-end">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-blue-500 to-brand-tan rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all"
            >
              Next: Scope Areas
        ...
        <div className="space-y-6">
          <div className="p-4 rounded-lg border border-blue-500/50 bg-blue-500/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-blue-400 mb-1">
                  Why measure individual rooms?
                </h3>
                <p className="text-sm text-slate-300">
                  Equipment needs are calculated based on the{" "}
                  <strong>Volume of Air</strong> (for Dehumidifiers) and the{" "}
                  <strong>Affected Floor Area</strong> (for Air Movers). Don't
                  guess! Measure length, width, and estimate what % of the
                  carpet/floor is actually wet.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewArea({
                      ...newArea,
                      wetPercentage: parseInt(e.target.value),
                    })
                  }
                  className="w-full"
                />
                <div className="text-xs text-center mt-1">
                  {newArea.wetPercentage}%
                </div>
              </div>
            ...
            {areas.length > 0 && (
              <div className="grid md:grid-cols-2 gap-4">
                {areas.map((area) => {
                  ...
                  const wetArea =
                    area.length * area.width * (area.wetPercentage / 100);
                  return (
                    <div
                      key={area.id}
                    ...
                    >
                      ...
                      <div className="text-sm mb-2">
                        <span className="text-slate-400">WET AREA:</span>{" "}
                        {wetArea.toFixed(1)}m²
                      </div>
        ...
        <div className="space-y-6">
          <div className="p-4 rounded-lg border border-green-500/50 bg-green-500/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-300">
                  The system has calculated your targets based on the previous
                  steps. Use the 'Auto-Select Best Fit' button to instantly load
                  standard Australian equipment ('Ave' classes) that meet these
                  targets, or manually pick items from your truck inventory.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-brand-tan rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all"
              >
                    ...
                    return (
                      <div
                        ...
                        className={`p-3 rounded-lg border ${
                          quantity > 0
                            ? "border-brand-navy/50 bg-brand-navy/10"
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-brand-tan mt-1">
                              $
                              {(
                                selection?.dailyRate ||
                                (pricingConfig
                          ...
                          {quantity > 0 && (
                            <div className="px-3 py-1 bg-brand-navy/20 text-brand-tan rounded text-sm font-semibold mr-2">
                              {quantity}
                            </div>
                          )}
              ...
              <div className="p-4 rounded-lg border border-slate-700/50 bg-slate-800/30">
                ...
                <p className="text-xs text-slate-400 mb-3">
                  Use for containment/filtration scenarios (mould, Category 2/3
                  contamination, demolition dust).
                </p>
                <div className="space-y-2">
                  {afdUnits.map((group) => {
                    const selection = equipmentSelections.find(
          ...
          <div className="flex justify-between">
            ...
            <button
              onClick={handleSave}
              disabled={loading}
              className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-green-500 to-brand-bronze rounded-lg font-medium hover:shadow-lg hover:shadow-green-500/50 transition-all disabled:opacity-50"
            >
