...
export default function CostEstimationViewer({
  reportId,
  onEstimationGenerated,
}: CostEstimationViewerProps) {
    ...
    return {
      header: {
        ...
        reportNumber:
          ...
          reportData?.claimReferenceNumber ||
          data.claimReference ||
          "N/A",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            {costDocument
              ? "View your generated cost estimation document"
              : "Generate your comprehensive cost estimation document"}
          </p>
        </div>
      ...
      {!costDocument && (
        <div className="p-6 rounded-lg border border-amber-500/50 bg-amber-500/10">
          ...
          <p className="text-slate-300 mb-4">
            Generate your comprehensive cost estimation document with detailed
            cost breakdowns by category, industry comparisons, and all necessary
            disclaimers.
          </p>
          <button
      ...
      {costDocument && costData && (
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 overflow-hidden">
            {costData ? (
              <VisualCostEstimationViewer
                data={convertToVisualCostData(costData, businessInfo, report)}
              />
            ) : (
