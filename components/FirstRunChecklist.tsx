    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          <Sparkles size={14} className="text-brand-tan flex-shrink-0" />
          <span className="font-semibold text-neutral-800 dark:text-slate-100 text-xs leading-tight">
            Get started
          </span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] font-medium text-brand-tan dark:text-brand-tan">
      ...
      <div className="w-full h-1 rounded-full bg-cyan-200/60 dark:bg-cyan-800/40 mb-3">
        <div
          className="h-1 rounded-full bg-gradient-to-r from-blue-500 to-brand-tan transition-all duration-500"
            ...
            >
              <div className="flex-shrink-0 mt-px">
                {step.completed ? (
                  ...
                  <Circle
                    size={14}
                    className="text-brand-tan dark:text-brand-tan"
                  />
                )}
              </div>
              ...
              {!step.completed && (
                <ChevronRight
                  size={12}
                  className="flex-shrink-0 mt-1 text-brand-tan dark:text-brand-tan"
                />
              )}
            </Link>
          </li>
      ...
      <button
        ...
        className={cn(
          ...
          "text-cyan-700 dark:text-brand-tan",
          "hover:bg-cyan-100 dark:hover:bg-cyan-900/40",
          "hover:border-brand-navy dark:hover:border-brand-navy",
        )}
      >
