...
export function SignatoryFlowTimeline({
    ...
    switch (status) {
      case "completed":
        return {
          ...
          border: "border-brand-bronze dark:border-emerald-700",
          text: "text-emerald-700 dark:text-brand-bronze",
  ...
  const getRoleBadgeColor = (role: string) => {
    const roleColors: Record<string, string> = {
      ...
      CONTRACTOR:
        "bg-cyan-100 text-cyan-700 dark:bg-cyan-950/30 dark:text-brand-tan",
      PROPERTY_OWNER:
      ...
      <div className="hidden md:block">
        <div className="relative">
          ...
          <div
            ...
            style={{
              gridTemplateColumns: `repeat(${signatories.length}, minmax(0, 1fr))`,
            }}
          >
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      colors.border,
                      status === "pending" &&
                        "ring-4 ring-blue-100 dark:ring-blue-950/50 animate-pulse",
                    )}
                  >
              ...
              <div className="flex items-start gap-3">
                ...
                <div
                  className={cn(
                    ...
                    colors.border,
                    status === "pending" &&
                      "ring-4 ring-blue-100 dark:ring-blue-950/50",
                  )}
                >
...
export function SignatoryFlowSummary({
  signatories,
  className,
}: SignatoryFlowSummaryProps) {
  ...
  return (
    <div className={cn("space-y-2", className)}>
      <div className="flex items-center justify-between text-sm">
        ...
        {isComplete && (
          <span className="text-xs text-brand-bronze dark:text-brand-bronze flex items-center gap-1">
