    ...
    <div ref={containerRef} className="w-full">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mt-3">
            ...
            <div className="flex items-center gap-1 border border-gray-300 dark:border-slate-600 rounded-md p-1">
              <button
                ...
                className={`w-7 h-7 rounded border-2 ${
                  lineColor === "#000000"
                    ? "border-brand-navy ring-2 ring-cyan-200 dark:ring-cyan-800"
            ...
            <div className="flex items-center gap-1 border border-gray-300 dark:border-slate-600 rounded-md p-1">
              <button
                ...
                className={`w-7 h-7 rounded flex items-center justify-center ${
                  lineWidth === 1.5
                    ? "bg-cyan-100 dark:bg-cyan-950/30 border-brand-navy"
        ...
        <button
          ...
          onClick={handleSave}
          disabled={disabled || !hasSignature}
          className="flex items-center gap-1.5 px-4 py-1.5 text-sm font-medium rounded-md bg-brand-navy hover:bg-brand-navy text-white disabled:opacity-40 disabled:cursor-not-allowed transition-colors w-full sm:w-auto justify-center"
        >
