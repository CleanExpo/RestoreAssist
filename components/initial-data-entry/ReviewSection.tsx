...
import { ArrowRight, Droplets, FileText, MapPin, Wrench } from "lucide-react";
...
interface Props {
  ...
  nirMoistureReadings: MoistureReading[];
  nirAffectedAreas: AffectedArea[];
            ...
            {nirMoistureReadings.map((reading) => (
              ...
              >
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <span
                    className={cn(
                      "font-semibold text-brand-bronze dark:text-brand-navy",
                    )}
                  >
            ...
            {nirAffectedAreas.map((area) => (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span
                    className={cn(
                      "text-xs px-2 py-1 bg-brand-bronze/20 text-brand-bronze dark:text-brand-navy rounded",
                    )}
                  >
      ...
      <div className="flex justify-end gap-4 pt-4 border-t border-neutral-200 dark:border-neutral-700">
        ...
        <button
          ...
          className={cn(
            ...
            "hover:from-blue-600 hover:to-brand-bronze",
