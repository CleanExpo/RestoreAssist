    ...
    <div className={cn("space-y-3", className)}>
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className={cn(
              ...
              "focus:ring-2 focus:ring-brand-bronze/50 focus:border-brand-bronze outline-none transition-all",
            )}
          />
        </div>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <div className="relative">
          <select
            ...
            className={cn(
              ...
              "border focus:outline-none focus:ring-2 focus:ring-brand-bronze/50",
              filters.status
                ? "border-brand-navy dark:border-brand-bronze bg-cyan-50 dark:bg-cyan-900/20 text-cyan-700 dark:text-brand-navy"
        ...
        <div className="relative flex items-center">
          <label className="text-xs text-neutral-400 dark:text-slate-500 mr-1.5 flex-shrink-0">
            From
          </label>
          <input
            type="date"
      ...
      {isPending && (
        <div className="flex items-center gap-2 text-xs text-neutral-400 dark:text-slate-500">
          <div className="w-3 h-3 rounded-full border-2 border-brand-bronze/30 border-t-brand-navy animate-spin" />
          Filtering…
        </div>
      )}
    </div>
