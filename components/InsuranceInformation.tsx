...
export default function InsuranceInformation({
  ...
  const propertyCoverItems = [
    {
      ...
      coverage:
        "Loss or damage to business premises, outbuildings, shelters, verandas, carports",
    },
    {
      id: "fixtures",
      ...
      coverage:
        "Built-in fixtures, permanent installations, structural fittings",
    },
    {
      id: "services",
    ...
    },
    {
      ...
      coverage:
        "Paths, roadways, fencing, permanent water and fuel tanks, gates, walls, signs",
    },
  ];
  ...
  const contentsCoverItems = [
    ...
    },
    {
      ...
      coverage:
        "Manufacturing equipment, production machinery, plant equipment",
    },
    {
      id: "stock",
  ...
  const liabilityCoverItems = [
    {
      ...
      coverage:
        "Claims from injured visitors, property damage to third parties",
    },
    {
      ...
      coverage:
        "Legal liability for business operations, professional services",
    },
    {
      id: "thirdParty",
  ...
  const getCoverageStats = () => {
    ...
    const selectedItems = Object.values(insuranceData).reduce(
      (acc, section) => {
    ...
    return {
      ...
      total: totalItems,
      percentage: Math.round((selectedItems / totalItems) * 100),
    };
  };
          ...
          <div className="space-y-4">
            <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-blue-300">
                Covers loss or damage to your business's physical buildings,
                fixtures, fittings, and structural improvements.
              </p>
            </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      id={item.id}
                      checked={
                        insuranceData.propertyCover[
                          item.id as keyof typeof insuranceData.propertyCover
                        ]
                      }
                      onChange={(e) =>
                ...
                >
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      id={item.id}
                      checked={
                        insuranceData.contentsCover[
                          item.id as keyof typeof insuranceData.contentsCover
                        ]
                      }
                      onChange={(e) =>
                        handleCoverageChange(
          ...
          <div className="space-y-4">
            <div className="bg-amber-500/20 border border-amber-500/30 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-amber-300">
                Protects against claims from injured third parties and damage to
                client property.
              </p>
            </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      id={item.id}
                      checked={
                        insuranceData.liabilityCover[
                          item.id as keyof typeof insuranceData.liabilityCover
                        ]
                      }
                      onChange={(e) =>
                        handleCoverageChange(
                ...
                >
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      id={item.id}
                      checked={
                        insuranceData.businessInterruption[
                          item.id as keyof typeof insuranceData.businessInterruption
                        ]
                      }
                      onChange={(e) =>
                        handleCoverageChange(
                ...
                >
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      id={item.id}
                      checked={
                        insuranceData.additionalCover[
                          item.id as keyof typeof insuranceData.additionalCover
                        ]
                      }
                      onChange={(e) =>
                        handleCoverageChange(
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            Select the insurance coverage relevant to your restoration project
          </p>
        </div>
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-4">
          <div className="text-center">
            ...
            <div className="text-xs text-slate-500">
              {stats.selected} of {stats.total} items
            </div>
          </div>
        </div>
      </div>
