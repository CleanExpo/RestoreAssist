...
export default function DryingPlanTemplates({
  ...
  const getPsychrometricTargets = () => {
    ...
    return {
      humidity:
        targets.humidity[waterClass as keyof typeof targets.humidity] || 40,
      temperature:
        targets.temperature[waterClass as keyof typeof targets.temperature] ||
        24,
    };
  };
  ...
  const getSystemRequirements = () => {
    ...
    switch (template?.systemType) {
      ...
      case "combination":
        return {
          description:
            "Mixed approach using both ventilation and dehumidification",
          requirements: [
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold text-orange-400">
                {dryingPlan.estimatedDryingTime}h
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold text-orange-400">
                {dryingPlan.targetTemperature}°C
              </span>
            </div>
