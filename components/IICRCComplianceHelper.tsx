  ...
  return (
    <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6">
      <div className="flex items-center gap-3 mb-6">
        <BookOpen className="text-brand-tan" size={24} />
        <h3
      ...
      >
            ...
            {categoryGuidelines && (
              <div>
                <h4 className="text-lg font-medium text-white mb-3 flex items-center gap-2">
                  <Droplets className="text-brand-tan" size={20} />
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-slate-300">
                  <li className="flex items-center gap-2">
                    <CheckCircle size={14} className="text-brand-bronze" />
        ...
        {activeTab === "equipment" && (
          <div className="space-y-6">
            {equipmentNeeds && (
              <div className="bg-brand-navy/20 border border-brand-navy/30 rounded-lg p-4">
                <h4 className="font-medium text-brand-tan mb-3">
        ...
        {activeTab === "procedures" && (
          <div className="space-y-4">
              ...
              <div>
                ...
                <ol className="space-y-2 text-sm text-slate-300">
                  <li className="flex items-start gap-2">
                    <span className="bg-brand-navy text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">
                      1
                    </span>
            ...
            <div className="bg-brand-bronze/20 border border-brand-bronze/30 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-sm text-brand-bronze">
