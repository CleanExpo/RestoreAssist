...
const changeTypeStyles: Record<ChangeType, string> = {
  added: "bg-info-subtle text-info-subtle-foreground",
  major: "bg-destructive-subtle text-destructive-subtle-foreground",
  minor:
    "bg-warning-subtle text-warning-subtle-foreground",
  patch: "bg-success-subtle text-success-subtle-foreground",
  removed: "bg-slate-100 text-slate-700 dark:bg-slate-900/30 dark:text-slate-400",
};
