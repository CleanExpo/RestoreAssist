            ...
            {!loading &&
              items.map((it) => (
                <button
                  ...
                  className="w-full text-left p-3 rounded-lg border border-slate-700 hover:border-brand-navy hover:bg-slate-800 transition-colors"
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="text-right shrink-0">
                      <div className="text-sm font-semibold text-brand-tan">
                        ${it.rate.toFixed(2)}
                      </div>
