...
export default function VisualDashboardReport({
  data,
}: VisualDashboardReportProps) {
  if (!data) {
    return (
  ...
  try {
    ...
    const safeSafety = {
      trafficLight:
        safety?.trafficLight === "occupied" || safety?.trafficLight === "vacant"
    ...
    const hasBusinessInfo =
      businessInfo.businessName || businessInfo.businessLogo;

    return (
      <div
        id="visual-report-content"
        className="bg-white p-8 rounded-lg shadow-lg w-full print-content print:p-0 print:shadow-none"
      >
        {/* Header */}
        <div className="mb-6">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 mt-1 text-xs text-slate-500">
                      {businessInfo.businessABN && (
                        <span>ABN: {businessInfo.businessABN}</span>
                      )}
                      {businessInfo.businessPhone && (
                        <span>Phone: {businessInfo.businessPhone}</span>
                      )}
                      {businessInfo.businessEmail && (
                        <span>Email: {businessInfo.businessEmail}</span>
                      )}
                    </div>
                  </div>
                </div>
          ...
          <div className="text-sm text-slate-600 space-y-1 border-t border-slate-200 pt-3">
            <p>
              <strong>Claim Ref:</strong> {safeHeader.claimRef}{" "}
              {safeHeader.location && `| ${safeHeader.location}`}
            </p>
            <p>
              <strong>Date:</strong> {safeHeader.date}
            </p>
            <p>
              <strong>Occupancy:</strong> {safeHeader.occupancy}
              {safeHeader.occupancyDetails &&
                ` (${safeHeader.occupancyDetails})`}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col">
            ...
            <p className="text-2xl font-bold text-slate-900">
              {safeSummaryMetrics.roomsAffected}
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col">
            ...
            <p className="text-sm font-semibold text-slate-900 leading-tight">
              {safeSummaryMetrics.materialsAffected}
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col">
            ...
            <p className="text-2xl font-bold text-slate-900">
              Avg. {safeSummaryMetrics.moistureLevel}%
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col">
            ...
            <p className="text-lg font-bold text-slate-900">
              {safeSummaryMetrics.dryingStatus}
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col">
            ...
            <p className="text-lg font-bold text-slate-900">
              {safeSummaryMetrics.totalLitresExtracted}
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col">
            ...
            <p className="text-lg font-bold text-slate-900">
              {safeSummaryMetrics.estimatedDuration} Days
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col">
            ...
            <p className="text-lg font-bold text-slate-900">
              {safeSummaryMetrics.dryingIndex}
            </p>
          </div>
        </div>
            ...
            <div className="bg-slate-100 rounded-lg p-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs text-slate-600 text-center">
                  {safeSafety.trafficLight === "occupied"
                    ? "Occupied"
                    : "Vacant"}
          ...
          {roomDetails.map((room, idx) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm text-black">
                <p>
                  <strong>Materials:</strong> {room.materials}
                </p>
                <p>
                  <strong>Moisture:</strong> {room.moisture}% - Target:{" "}
                  {room.targetMoisture}%
                </p>
                <p>
                  <strong>Current moisture:</strong> {room.status}
                </p>
                <p>
                  <strong>Scope of work:</strong> {room.scopeOfWork}
                </p>
                <div className="mt-2">
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-6">
            ...
            <h4 className="text-sm font-semibold text-slate-700 mb-4 uppercase">
              EQUIPMENT
            </h4>
            ...
            <p className="mt-4 text-sm text-slate-600">
              <strong>Total reserve:</strong> {estimatedDays} days
            </p>
          </div>
        </div>
      ...
      <div className="print:page-break-before-always bg-white p-8 rounded-lg shadow-lg print:shadow-none">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="font-semibold text-slate-900">
                  {fullData.property?.clientName || "Not provided"}
                </p>
              </div>
              <div>
            ...
            <div className="space-y-3">
              {fullData.incident?.dateOfLoss && (
                <div>
                  ...
                  <p className="font-semibold text-slate-900">
                    {formatDate(fullData.incident.dateOfLoss)}
                  </p>
                </div>
              )}
              {fullData.incident?.technicianAttendanceDate && (
                <div>
                  ...
                  <p className="font-semibold text-slate-900">
                    {formatDate(fullData.incident.technicianAttendanceDate)}
                  </p>
                </div>
              )}
        ...
        {fullData.property?.accessNotes && (
          <div className="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg p-5 border-2 border-amber-300 shadow-sm">
            ...
            <p className="text-warning leading-relaxed pl-8">
              {fullData.property.accessNotes}
            </p>
          </div>
        )}
      ...
      <div className="print:page-break-before-always bg-white p-8 rounded-lg shadow-lg print:shadow-none">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          {(() => {
            const hasEnvData =
              ...
              ((fullData.environmental.ambientTemperature !== null &&
                fullData.environmental.ambientTemperature !== undefined) ||
                (fullData.environmental.humidityLevel !== null &&
                  fullData.environmental.humidityLevel !== undefined) ||
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {fullData.environmental.humidityLevel !== null && (
                  <div className="bg-white rounded-lg p-4 text-center border border-blue-100">
                    ...
                    <p className="text-2xl font-bold text-slate-900">
                      {fullData.environmental.humidityLevel}%
                    </p>
                  </div>
                )}
                {fullData.environmental.dewPoint !== null && (
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-6 border-2 border-blue-200 shadow-sm">
              ...
              <p className="text-slate-600 italic">
                No environmental data recorded for this inspection.
              </p>
            </div>
          )}
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border-2 border-green-200 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <span className="inline-block px-4 py-2 rounded-lg text-base font-bold bg-green-100 text-success border border-green-300">
          ...
          {fullData.psychrometric ? (
              ...
              <div className="grid md:grid-cols-4 gap-4 mb-4">
                {fullData.psychrometric.dryingIndex !== null && (
                  <div className="bg-white rounded-lg p-4 text-center border border-orange-200">
                    ...
                    <p className="text-3xl font-bold text-slate-900">
                      {fullData.psychrometric.dryingIndex}
                    </p>
                  </div>
                )}
                {fullData.psychrometric.dryingStatus && (
                  <div className="bg-white rounded-lg p-4 text-center border border-orange-200">
                    ...
                    <span className="inline-block px-4 py-2 rounded-lg text-base font-bold bg-yellow-100 text-warning border border-yellow-300">
                ...
                {fullData.psychrometric.temperature !== null && (
                  <div className="bg-white rounded-lg p-4 text-center border border-orange-200">
                    ...
                    <p className="text-lg font-bold text-slate-900">
                      {fullData.psychrometric.temperature}°C
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg p-6 border-2 border-orange-200 shadow-sm">
              ...
              <p className="text-slate-600 italic">
                No psychrometric assessment data available.
              </p>
            </div>
          )}
        </div>
                    ...
                    area.moistureReadings.length > 0 && (
                      <div className="mb-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          {area.moistureReadings.map(
                            (reading: any, rIdx: number) => (
                              <div
                                key={rIdx}
                    ...
                    <div className="mt-4">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {area.photos.map((photoUrl: string, pIdx: number) => (
                          <div
                            key={pIdx}
                            className="relative aspect-square rounded-lg overflow-hidden border-2 border-slate-300 shadow-md"
                          >
                            <img
                              src={photoUrl}
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-cyan-100 to-blue-100">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-right text-sm font-bold text-slate-900 uppercase tracking-wide">
                      Moisture Level
                    </th>
                    <th className="px-6 py-4 text-left text-sm font-bold text-slate-900 uppercase tracking-wide">
                      Depth
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-green-100 to-emerald-100">
                  <tr>
                    ...
                    {fullData.scopeItems.some(
                      (item: any) => item.justification,
                    ) && (
                      <th className="px-6 py-4 text-left text-sm font-bold text-slate-900 uppercase tracking-wide">
                        Justification
                      </th>
                ...
                <tbody className="divide-y divide-slate-200">
                  {fullData.scopeItems.map((item: any, idx: number) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <span className="inline-block px-3 py-1 rounded-full text-sm font-bold bg-green-100 text-success">
                          {item.quantity}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-slate-700">{item.unit}</td>
                      {fullData.scopeItems.some(
                        (i: any) => i.justification,
                      ) && (
              ...
              <table className="w-full">
                ...
                <tfoot className="bg-gradient-to-r from-slate-100 to-slate-200">
                  <tr>
                    <td
                      colSpan={4}
                      className="px-6 py-4 text-right font-bold text-slate-900 text-lg"
                    >
          ...
          <div className="print:page-break-before-always bg-white p-8 rounded-lg shadow-lg print:shadow-none">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {fullData.photos.map((photo: any, idx: number) => (
                <div
                  key={idx}
                  className="relative aspect-square rounded-lg overflow-hidden border-2 border-slate-300 shadow-md group"
                >
                  <img
                    src={photo.url}
            ...
            <div className="mt-4 text-center text-sm text-slate-600">
              <p>
                Total: {fullData.photos.length} photograph
                {fullData.photos.length !== 1 ? "s" : ""}
              </p>
            </div>
          </div>
        )}
                ...
                <div className="space-y-3">
                  ...
                  {fullData.hazards.biologicalMouldDetected && (
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="font-semibold text-warning">
                          Biological Mould Detected: Yes
                        </p>
                        {fullData.hazards.biologicalMouldCategory && (
                          <p className="text-sm text-warning">
                            Category: {fullData.hazards.biologicalMouldCategory}
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  {fullData.hazards.asbestosRisk && (
                    <div className="flex items-center gap-2">
                      <AlertTriangle className="w-5 h-5 text-warning" />
                      <p className="font-semibold text-warning">
                        Asbestos Risk: Pre-1990 building identified
                      </p>
                    </div>
                  )}
                  {fullData.hazards.leadRisk && (
                    <div className="flex items-center gap-2">
                      <AlertTriangle className="w-5 h-5 text-warning" />
                      <p className="font-semibold text-warning">
                        Lead Risk: Pre-1990 building identified
                      </p>
                    </div>
                  )}
                </div>
            ...
            {fullData.compliance && (
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border-2 border-green-200 shadow-sm">
                ...
                <ul className="space-y-3">
                  {fullData.compliance.standards.map(
        ...
        <div className="print:page-break-before-always border-t-2 border-slate-300 pt-6 mt-8">
          <div className="text-center text-sm text-slate-600">
            ...
            {businessInfo?.businessABN && (
              <p>ABN: {businessInfo.businessABN}</p>
            )}
            {businessInfo?.businessPhone && (
              <p>Phone: {businessInfo.businessPhone}</p>
            )}
            {businessInfo?.businessEmail && (
              <p>Email: {businessInfo.businessEmail}</p>
            )}
            <p className="mt-4">
              This report was generated on{" "}
              {formatDate(fullData.header?.dateGenerated)}
            </p>
            <p className="mt-2 text-xs">
              © {new Date().getFullYear()}{" "}
              {businessInfo?.businessName || "RestoreAssist"}. All rights
              reserved.
            </p>
          </div>
        </div>
