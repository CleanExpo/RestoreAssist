  ...
  useEffect(() => {
    if (initialEstimateData && isInitialMount.current) {
      try {
        ...
        const lineItems =
          initialEstimateData.lineItems !== undefined &&
          initialEstimateData.lineItems !== null
        ...
        const parsedData: any = {
          ...estimateData,
          rateTables:
            initialEstimateData.rateTables !== undefined &&
            initialEstimateData.rateTables !== null
          ...
          commercialParams:
            initialEstimateData.commercialParams !== undefined &&
            initialEstimateData.commercialParams !== null
          ...
          lineItems: lineItems,
          assumptions:
            initialEstimateData.assumptions !== undefined
              ? initialEstimateData.assumptions
              : estimateData.assumptions,
          inclusions:
            initialEstimateData.inclusions !== undefined
              ? initialEstimateData.inclusions
              : estimateData.inclusions,
          exclusions:
            initialEstimateData.exclusions !== undefined
              ? initialEstimateData.exclusions
              : estimateData.exclusions,
          allowances:
            initialEstimateData.allowances !== undefined
              ? initialEstimateData.allowances
              : estimateData.allowances,
          complianceStatement:
            initialEstimateData.complianceStatement !== undefined
              ? initialEstimateData.complianceStatement
              : estimateData.complianceStatement,
          disclaimer:
            initialEstimateData.disclaimer !== undefined
              ? initialEstimateData.disclaimer
          ...
          labourSubtotal:
            initialEstimateData.labourSubtotal !== undefined
              ? initialEstimateData.labourSubtotal
              : 0,
          equipmentSubtotal:
            initialEstimateData.equipmentSubtotal !== undefined
              ? initialEstimateData.equipmentSubtotal
              : 0,
          chemicalsSubtotal:
            initialEstimateData.chemicalsSubtotal !== undefined
              ? initialEstimateData.chemicalsSubtotal
              : 0,
          subcontractorSubtotal:
            initialEstimateData.subcontractorSubtotal !== undefined
              ? initialEstimateData.subcontractorSubtotal
              : 0,
          travelSubtotal:
            initialEstimateData.travelSubtotal !== undefined
              ? initialEstimateData.travelSubtotal
              : 0,
          wasteSubtotal:
            initialEstimateData.wasteSubtotal !== undefined
              ? initialEstimateData.wasteSubtotal
              : 0,
          overheads:
            initialEstimateData.overheads !== undefined
              ? initialEstimateData.overheads
              : 0,
          profit:
            initialEstimateData.profit !== undefined
              ? initialEstimateData.profit
              : 0,
          contingency:
            initialEstimateData.contingency !== undefined
              ? initialEstimateData.contingency
              : 0,
          escalation:
            initialEstimateData.escalation !== undefined
              ? initialEstimateData.escalation
              : 0,
          subtotalExGST:
            initialEstimateData.subtotalExGST !== undefined
              ? initialEstimateData.subtotalExGST
              : 0,
          gst:
            initialEstimateData.gst !== undefined ? initialEstimateData.gst : 0,
          totalIncGST:
            initialEstimateData.totalIncGST !== undefined
              ? initialEstimateData.totalIncGST
              : 0,
        };
        ...
        console.error(
          "Error parsing initial estimate data:",
          error,
          initialEstimateData,
        );
