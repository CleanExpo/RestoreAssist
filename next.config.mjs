...
const nextConfig = {
  typescript: {
    // RA-5193: baseline cleared 2026-05-25 (lint + type-check at 0
    // problems). Build now type-checks — any new TS error fails the
    // Vercel build instead of leaking to runtime.
