# Pilot Outreach Kit — Sprint J Demo

**Issue:** RA-431
**Companies:** Beyond Clean Group · Elite Restoration Australia · CRSA
**Date:** 2026-04-07
...
**To:** [Contact via crsaustralia.com.au]
**Subject:** RestoreAssist — IICRC reporting platform, 10-min demo for CRSA?
...
"Thanks for making the time. I'll keep this to 15 minutes — I want to show you three specific things and get your honest reaction.
...
### Part 2 — Insurer share portal (4 min)

"Now here's the part that saves the most time."
...
**Say:** "The insurer gets a link. No login, no app, no PDF emailed back and forth. The link is valid for 30 days — if the loss adjuster goes on leave, no problem. And if they need the formal PDF for the file, it's one click."

---

### Part 3 — PDF download (2 min)
...
"Three questions before I let you go:

1. How does this compare to what you're doing today?
...
## Follow-Up Template (post-demo)

**Subject:** RestoreAssist — next steps after our call

---

Hi [Name],

Thanks for 15 minutes today. [Personalised one-liner based on their feedback.]

Here's what I'd suggest as next steps:

1. **Pilot access** — I can set up your account today. No cost, full features, for [agreed period].
2. **First report** — Try it on a real job this week. I'll be available if anything needs adjusting.
3. **Feedback call in 2 weeks** — 20 minutes to hear what's working and what isn't.

Reply to this email and I'll send you the setup link.
