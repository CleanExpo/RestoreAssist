...
Use this skill when the user wants to share the frontmost macOS app window with Codex, asks how to take an appshot, or provides appshot context for a task.
