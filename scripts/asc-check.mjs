...
await page.goto("https://appstoreconnect.apple.com/apps/6761808113/distribution/ios/version/inflight", {
...
const lines = txt.split('\n').filter(l => l.trim() && (
  l.includes("Build") || l.includes("1.0") || l.includes("Status") ||
  l.includes("Review") || l.includes("Waiting") || l.includes("Processing") ||
  l.includes("Rejected") || l.includes("Sale") || l.includes("Submitted")
));
...
for (const ta of tas) {
  await ta.click(); await page.keyboard.selectAll(); await ta.fill(REVIEW_NOTES);
