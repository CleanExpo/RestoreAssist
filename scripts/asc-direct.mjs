...
const TARGET_URL = "https://appstoreconnect.apple.com/apps/6761808113/distribution/ios/version/inflight";
...
await page.goto(TARGET_URL, { timeout: 30000, waitUntil: "domcontentloaded" }).catch(() => {});
...
if (await addBuildBtn.isVisible({ timeout: 5000 })) {
  ...
  // Look for 1.0 (10)
  const rows = await page.locator("td, tr, li, [role='option'], [role='row']").all();
