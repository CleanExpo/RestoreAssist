...
**Owner:** Phill McGurk
**Sprint:** Q3 2026
**Priority:** Low — plan by June 2026, execute August 2026

---

## Strategic Objectives

1. **CARSI/NRPG partnership conversation** — The YouTube curriculum CPD pathway needs a formal endorsement partner. RIA conference is the best venue to initiate this with both organisations present.
2. **Competitor intelligence** — Assess TM+, RestorationX, iRestore presence and positioning
3. **Panel insurer relationship building** — IAG, Suncorp, QBE representatives typically attend
4. **RestoreAssist demo to 10+ qualified prospects** — target restoration companies with 5+ staff

---

## Registration Checklist

- [ ] Register at [ria.org.au/conference](https://www.ria.org.au) (early bird closes ~June 2026)
- [ ] Book accommodation: The Star Gold Coast or nearby (block out 3 nights: travel day + 2 conference days)
- [ ] Register for networking dinner (usually Day 1 evening — high-value relationship event)
- [ ] Check exhibitor/sponsor packages — evaluate 2m² booth vs sponsored session

**Budget estimate:**
| Item | Estimated Cost |
|------|---------------|
| Conference registration | $1,200–$2,400 AUD |
| Accommodation (3 nights) | $800–$1,200 AUD |
| Flights (from [home city]) | $400–$800 AUD |
| Exhibitor booth (optional) | $3,000–$8,000 AUD |
| Demo materials / printed collateral | $200–$500 AUD |
| **Total (no booth)** | **~$3,000 AUD** |
| **Total (with booth)** | **~$10,000 AUD** |

**Recommendation (Year 1):** Attend as delegate, not exhibitor. Network at conference events rather than staffing a booth. Exhibitor investment better suited to Year 2 once product-market fit is validated.

---

## Demo Preparation (2 weeks before conference)

### Demo Script — Core 12-minute walkthrough

**Audience:** Restoration company owner/manager, 5–50 staff
...
4. Show the 7 sections appear with IICRC §references
5. Highlight equipment quantities auto-justified against S500 §11 ratios
...
4. Add equipment placement markers (2 LGR dehu, 4 air movers)
...
4. Enter moisture readings → shows offline storage
...
## CARSI/NRPG Partnership Conversation Guide

**Target contact:** CARSI Education Committee or NRPG Professional Development lead
...
4. The curriculum maps specifically to CARSI/NRPG requirements (show RA-297 document)

**Ask:** "Would you be open to a 30-minute call after the conference to explore formal accreditation?"
...
- [ ] Offline demo mode: pre-load scope generator so it works without internet
