...
- P0 query/raw SQL/error leakage routes are not fully patched; API audit currently reports 0 errors and 26 warnings.
...
Error: advisory API route scan reports 0 error-severity findings and 26 warnings.
