...
2. Add a user-visible message when `floorPlanImages` is empty: _"Floor plan not found — photograph the original site sketch using the import button."_ This sets expectations and funnels users toward RA-1607's manual path.
