 ...
 * both of which require new Function() / eval() in the browser. Track fabric.js v7+
 * for a potential removal path.
 *
...
export function middleware(request: NextRequest) {
  ...
  const cspDirectives = [
    ...
    `script-src 'self' 'nonce-${nonce}' 'strict-dynamic' 'unsafe-eval' https://apis.google.com https://*.firebaseapp.com https://*.googleapis.com`,
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "img-src 'self' data: blob: https://res.cloudinary.com https://lh3.googleusercontent.com https://*.stripe.com https://*.supabase.co",
