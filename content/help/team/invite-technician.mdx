...
<Screenshot src="ra-help/team/invite-modal" alt="The invite technician modal with email and role fields" caption="Roles map to the role-based disclosure rules in lib/progress." />
...
<Screenshot src="ra-help/team/engagement-licence-modal" alt="The engagement licence modal showing IICRC, WHS, and state licence fields" caption="Each row stores a hashed authorisation record; the original numbers are never re-displayed in plaintext." />
