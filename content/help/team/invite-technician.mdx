...
relatedSlugs: []
aiSummary: "Walks an admin through inviting a technician via single-use invite token, collecting their IICRC certification + WHS + state-licence numbers via the EngagementLicenceModal, and verifying engagement-time per IICRC S500:2025 §5 attribution rules."
userIntents:
