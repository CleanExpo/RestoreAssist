          ...
          <div style={{display:'flex', gap:32}}>
            {screens.map((screen,i) => (
              <div key={screen.label} style={{
                width:220, padding:32, borderRadius:20, backgroundColor:'#1e293b', border:'2px solid #334155',
                textAlign:'center',
                ...
                <p style={{fontSize:14, color:'#94a3b8', lineHeight:1.5}}>{screen.desc}</p>
              </div>
            ))}
          </div>
          <div style={{marginTop:48, padding:'16px 32px', borderRadius:12, backgroundColor:'#dc2626', color:'#fff', fontSize:16, fontWeight:700}}>
