...
export const metadata: Metadata = {
  ...
  description:
    "Discover RestoreAssist features: AI-powered damage assessment, IICRC S500 compliance, real-time cost calculation, and multi-hazard support for Australian restoration professionals.",
  keywords: [
