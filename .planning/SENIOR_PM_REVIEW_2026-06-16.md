...
| **5.5** Standards Library | in progress | Versioned standards registry (single source); expand corpus (S520:2024/S700/S540/state codes); **staleness gate** replacing degrade-open; normalise 74 S520:2015 citations across 17 files (#16) | **Yes** (S520:2024 source, library owner+cadence, IICRC rights, Lens+Vex sign-off) |
...
- **Standards currency** (§5.5 #16) contaminates §5.4 Lens defensibility — §5.4 cannot pass its review while it emits S520:2015 citations against a UI advertising S520:2024.
