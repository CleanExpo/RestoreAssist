    ...
    formSchema: JSON.stringify({
      sections: [
        ...
        },
        {
          ...
          fields: [
            { id: "readings", type: "array", label: "Moisture Readings", itemType: "object" },
          ]
        },
        {
          id: "affectedAreas",
          ...
          fields: [
            { id: "areas", type: "array", label: "Affected Areas", itemType: "object" },
          ]
        },
        {
          id: "equipment",
          ...
          fields: [
            { id: "equipment", type: "array", label: "Equipment", itemType: "object" },
          ]
        }
      ]
    }),
    ...
    formSchema: JSON.stringify({
      sections: [
        ...
        },
        {
          ...
          fields: [
            { id: "hazards", type: "array", label: "Hazards", itemType: "object" },
          ]
        },
        {
          id: "controls",
          ...
          fields: [
            { id: "controls", type: "array", label: "Control Measures", itemType: "object" },
          ]
        },
        {
          id: "ppe",
